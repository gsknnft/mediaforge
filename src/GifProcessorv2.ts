...
import { gifAnalyzer } from "./GifProcessor/analyzers/GifAnalyzer";
import { QualityAnalyzer } from "./GifProcessor/analyzers/QualityAnalyzer";
import {
  CONSTANTS,
  QUALITY_PRESETS,
} from "./GifProcessor/constants/gif.constants";
...
import {
  GIF_PHASES,
  GIFProgressTracker,
} from "./GifProcessor/services/GIFProgressTracker";
...
import {
  ...
  QualityOptions,
  QualityPresetKey,
} from "./GifProcessor/types/gif.types";
...
export const gifProcessor = GIFProcessor.getInstance();
export { GIFProcessor };
