...
export class AssetRegistry {
  ...
  private constructor(backgroundCache?: Map<string, BackgroundAsset>, overlayCache?: Map<string, OverlayAsset>) {
  ...
  async getCached(name: string): Promise<AssetMetadata> {
  ...
  private isAvatar(asset: AssetMetadata): asset is BackgroundAsset {
