import { d as e, p as t } from "./VeraShellExporter-BCJ-wbue.mjs";
...
function g() {
	...
	let e = globalThis.importMeta;
	return e?.env ? e : globalThis.import_meta;
}
var _ = g()?.env ?? {};
function v(e, t = "") {
	let n = _[e];
...
function y() {
	let e = v("MODE", "");
	if (e) return e;
	let t = typeof process < "u" ? process.env.NODE_ENV : "";
	return typeof t == "string" ? t : "";
}
function b() {
	let e = g();
	return typeof e?.env?.DEV == "boolean" ? e.env.DEV : typeof e?.DEV == "boolean" ? e.DEV : y() === "development";
}
//#endregion
//#region src/assets/config/asset.config.ts
var x = y() || "development", S = b(), C = {
	baseUrl: S ? "http://localhost:3000/api" : "/api",
	endpoints: {
	...
	staging: {
		apiUrl: v("NEXT_PUBLIC_API_URL", "http://localhost:3000"),
		assetUrl: v("NEXT_PUBLIC_ASSET_URL", "http://localhost:3000/_assets"),
		cacheDuration: 18e5
	},
	production: {
		apiUrl: v("NEXT_PUBLIC_API_URL", "https://api.sigilnet.com"),
		assetUrl: v("NEXT_PUBLIC_ASSET_URL", "https://cdn.sigilnet.com/assets"),
		cacheDuration: 36e5
	}
}, T = S ? "/assets" : "/api/_assets", E = {
	backgrounds: {
		animated: `${T}/backgrounds/animated`,
		static: `${T}/backgrounds/static`,
		pixel: `${T}/backgrounds/pixel`
	},
	special: `${T}/overlays/special`,
	overlays: {
		head: `${T}/overlays/head`,
		clothes: `${T}/overlays/clothes`,
		special: `${T}/overlays/special`,
		frames: `${T}/overlays/frames`,
		traits: `${T}/overlays/traits`,
		accessories: `${T}/overlays/accessories`
	}
}, D = {
	...
	cacheDuration: D.defaultDuration
}, A = {
	getAsset: (e) => `${C.baseUrl}/assets/${e}`,
	getMetadata: (e) => `${C.baseUrl}/assets/metadata/${e}`,
	validateAsset: (e) => `${C.baseUrl}/assets/validate/${e}`,
	getBackgrounds: (e) => `${C.baseUrl}${C.endpoints.backgrounds}${e ? `?category=${e}` : ""}`,
	getOverlays: (e) => `${C.baseUrl}${C.endpoints.overlays}${e ? `?category=${e}` : ""}`
}, j = {
	images: [
		".png",
		".jpg",
	...
	async load(e, t) {
		...
		let r = await fetch(`${T}/${e}`), i = Buffer.from(await r.arrayBuffer());
	...
	value: e.value,
	category: e.category,
	disAllowedTraits: e.disAllowedTraits,
	dims: e.dims,
	tags: e.tags
}), L = (e, t, n, r, i, a, o) => ({
	name: e,
	...
	L("Santa Hat", "Head", "/assets/traits/head/SantaHat.png", { Head: ["Santa Hat"] }, "Santa Hat", { Head: [
		"Beer Hat",
		"Santa Hat",
		"Bucket Hat",
		"Hardhat"
	] }),
	L("Xmas Sweater", "Clothes", "/assets/traits/clothes/Xmas_Sweater.png", { Clothes: ["Xmas Sweater"] }, "Xmas Sweater", {
		clothes: ["Puffer", "DadBod"],
		extra: ["Baby Carlos"]
	}),
	L("Holiday Sweater", "Clothes", "/assets/traits/clothes/Holiday_Sweater.png", { Clothes: ["Holiday Sweater"] }, "Holiday Sweater", {
		Clothes: ["Puffer", "DadBod"],
		extra: ["Baby Carlos"]
	}),
	L("#1 Dad Hoodie", "Clothes", "/assets/traits/clothes/DadHoodie.png", { Clothes: ["#1 Dad Hoodie"] }, "#1 Dad Hoodie", {
		Clothes: ["Puffer", "DadBod"],
		extra: ["Baby Carlos"]
	})
], ee = /* @__PURE__ */ u(((e) => {
	...
	process.env.NODE_ENV !== "production" && (function() {
		...
		function T(e, t, n, i, a) {
			...
			if (s) {
				s = e, a = a(s);
				var c = i === "" ? "." + C(s, 0) : i;
				return ue(a) ? (n = "", c != null && (n = c.replace(ge, "$&/") + "/"), T(a, t, n, "", function(e) {
					return e;
			...
			else if (l = r(e), typeof l == "function") for (l === e.entries && (J || console.warn("Using Maps as children is not supported. Use an array of keyed ReactElements instead."), J = !0), e = l.call(e), l = 0; !(i = e.next()).done;) i = i.value, o = c + C(i, l++), s += T(i, t, n, o, a);
			else if (o === "object") {
		...
		for (Se in U) U.hasOwnProperty(Se) && n(Se, U[Se]);
		...
		}, G = Object.prototype.hasOwnProperty, fe = console.createTask ? console.createTask : function() {
			return null;
		};
		U = { react_stack_bottom_frame: function(e) {
			return e();
		} };
		var pe, K, me = {}, he = U.react_stack_bottom_frame.bind(U, m)(), q = fe(f(m)), J = !1, ge = /\/+/g, _e = typeof reportError == "function" ? reportError : function(e) {
			if (typeof window == "object" && typeof window.ErrorEvent == "function") {
				var t = new window.ErrorEvent("error", {
					bubbles: !0,
					cancelable: !0,
			...
			console.error(e);
		}, ve = !1, ye = null, Y = 0, be = !1, X = !1, xe = typeof queueMicrotask == "function" ? function(e) {
		...
		e.Activity = ie, e.Children = Se, e.Component = a, e.Fragment = L, e.Profiler = ee, e.PureComponent = s, e.StrictMode = R, e.Suspense = ne, e.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE = W, e.__COMPILER_RUNTIME = U, e.act = function(e) {
			var t = W.actQueue, n = Y;
			Y++;
			...
			if (t != null) {
				var o;
				a: {
					if (G.call(t, "ref") && (o = Object.getOwnPropertyDescriptor(t, "ref").get) && o.isReactWarning) {
						o = !1;
						break a;
					}
					o = t.ref !== void 0;
				}
				for (s in o && (a = p()), h(t) && (u(t.key), i = "" + t.key), t) !G.call(t, s) || s === "key" || s === "__self" || s === "__source" || s === "ref" && t.ref === void 0 || (r[s] = t[s]);
			}
			...
			r = {};
			var i = null;
			if (t != null) for (c in K || !("__self" in t) || "key" in t || (K = !0, console.warn("Your app (or one of its dependencies) is using an outdated JSX transform. Update to the modern JSX transform for faster performance: https://react.dev/link/new-jsx-transform")), h(t) && (u(t.key), i = "" + t.key), t) G.call(t, c) && c !== "key" && c !== "__self" && c !== "__source" && (r[c] = t[c]);
			var a = arguments.length - 2;
			if (a === 1) r.children = n;
			else if (1 < a) {
				for (var o = Array(a), s = 0; s < a; s++) o[s] = arguments[s + 2];
			...
			return v(e, i, r, p(), c ? Error("react-stack-top-frame") : he, c ? fe(f(e)) : q);
		}, e.createRef = function() {
			var e = { current: null };
			...
			try {
				var r = e(), i = W.S;
				i !== null && i(n, r), typeof r == "object" && r && typeof r.then == "function" && (W.asyncTransitions++, r.then(k, k), r.then(c, _e));
			} catch (e) {
				_e(e);
			} finally {
...
function B(e) {
	return e ? typeof e == "string" ? new Date(e).getTime() : e.getTime() : Date.now();
}
function ne(e, t, n) {
	return `${T}/${e}/${t}/${n}`;
}
var re = class e {
	...
	constructor(e, t) {
		this.backgroundCache = new Map(Object.entries(e || {})), this.overlayCache = new Map(Object.entries(t || {})), this.environment = x, this.fetchPromises = /* @__PURE__ */ new Map(), this.fetchUpdates(), this.initializeFromRegistry();
	}
	initializeFromRegistry() {
		this.initializedFromRegistry || (Object.values(this.backgroundCache).forEach((e) => {
			let t = this.getAssetId(e);
			this.backgroundCache.set(t, {
				...e,
				source: "registry"
			});
		}), Object.values(this.overlayCache).forEach((e) => {
			let t = this.getAssetId(e);
			this.overlayCache.set(t, {
				...e,
				source: "registry"
			});
	...
	getAssetId(e) {
		let t = globalThis?.importMeta?.env?.DEV ? "http://localhost:3000" : "https://apefathers.com";
		return `${e.id || `${e.type}-${e.name.toLowerCase().replace(/\s+/g, "-")}`}-${new URL(e.url, t).pathname}`;
	}
	async fetchUpdates() {
		...
		let [e, t] = await Promise.all([this.fetchBackgrounds(), this.fetchOverlays()]);
		e.forEach((e) => this.backgroundCache.set(this.getAssetId(e), e)), t.forEach((e) => this.overlayCache.set(this.getAssetId(e), e));
	}
	async fetchBackgrounds() {
		try {
			console.log("📊 Environment:", this.environment), console.log("💾 Cache size:", this.backgroundCache.size);
			let e = A.getBackgrounds();
			console.log("🔍 Fetching backgrounds from:", e);
			let t = await this.fetchWithCache(e, () => this.fetchWithTimeout(e, { headers: {
				...C.headers,
				"X-Asset-Environment": this.environment
			} }));
			if (!t.ok) throw Error(`HTTP error! status: ${t.status}`);
			let n = (await t.json()).filter((e) => {
				let t = this.getAssetId(e);
				return !this.backgroundCache.has(t) || e.lastModified > (this.backgroundCache.get(t)?.lastModified || 0);
			});
			return console.log("✅ Unique backgrounds:", n.length), n;
		} catch (e) {
	...
	async fetchOverlays() {
		try {
			...
			if (!t.ok) throw Error(`HTTP error! status: ${t.status}`);
			let n = await t.json();
			console.log("✅ Fetched overlays:", n.length);
			let r = n.filter((e) => !Array.from(this.overlayCache.values()).find((t) => t.url === e.url));
	...
	async getAllBackgrounds() {
		...
		return Array.from(this.backgroundCache.values()).forEach((t) => {
			let n = this.getAssetId(t);
			(!e.has(n) || t.source === "api") && e.set(n, t);
	...
	async fetchWithCache(e, t) {
		if (this.fetchPromises.has(e)) return console.log(`⏳ Returning in-flight request for ${e}`), this.fetchPromises.get(e);
		let n = t().finally(() => this.fetchPromises.delete(e));
		return this.fetchPromises.set(e, n), n;
	}
	async fetchAssetMetadata(e) {
		try {
			let t = await this.fetchWithCache(e, () => fetch(A.getMetadata(e), { headers: {
				...C.headers,
				"X-Asset-Environment": this.environment
			} }));
			if (!t.ok) throw Error(`Failed to fetch asset metadata: ${t.statusText}`);
			return await t.json();
		} catch (e) {
			throw console.error("Error fetching asset metadata:", e), e;
		}
	}
	async fetchWithTimeout(e, t, n = 3e4) {
		...
		try {
			...
			throw t instanceof Error && t.name === "AbortError" && console.warn(`⚠️ Request aborted for ${e} after ${n}ms`), t;
		} finally {
			clearTimeout(i);
		}
	}
	async getCached(e) {
		let t = this.backgroundCache.get(e);
		if (t) return t;
		try {
			let t = await this.fetchAssetMetadata(e);
			if (this.isAvatar(t)) return this.backgroundCache.set(e, t), t;
		} catch (t) {
			console.error(`Error fetching background ${e}:`, t);
		}
		return this.backgroundCache.get(e) || null;
	}
	async getBackgroundsByCategory(e) {
		let t = await this.getAllBackgrounds();
		return t.length ? (console.log(`✅ Using cached backgrounds for category: ${e}`), t.filter((t) => t.bgCategory === e)) : (console.log(`🔍 Fetching backgrounds for category: ${e}`), (await this.getAllBackgrounds()).filter((t) => t.bgCategory === e));
	}
	async getOverlaysByCategory(e) {
		let t = await this.getAllOverlays();
		return t.length ? (console.log(`✅ Using cached backgrounds for category: ${e}`), t.filter((t) => t.overlayCategory === e)) : (console.log(`🔍 Fetching backgrounds for category: ${e}`), (await this.getAllOverlays()).filter((t) => t.overlayCategory === e));
	}
	isAvatar(e) {
		return e && e.type === "avatar" && "bgCategory" in e;
	}
	isOverlayAsset(e) {
...
//#endregion
//#region src/assets/hooks/useAssets.ts
var H = V();
function ie() {
	let [e, t] = (0, z.useState)(!1), [n, r] = (0, z.useState)(null), [i, a] = (0, z.useState)({
		backgrounds: [],
		overlays: []
	}), o = (0, z.useMemo)(() => /* @__PURE__ */ new Map(), []);
	return (0, z.useEffect)(() => () => {
		o.forEach((e) => {
			typeof e == "string" && URL.revokeObjectURL(e);
		}), o.clear();
	}, []), (0, z.useCallback)(async (e) => {
		if (o.has(e)) return o.get(e);
		let t = await (await fetch(e)).blob(), n = URL.createObjectURL(t);
		return o.set(e, n), n;
	}, [o]), (0, z.useEffect)(() => {
		(async () => {
			try {
				let { backgrounds: e, overlays: t } = await H.getAssets();
				a({
					backgrounds: e,
					overlays: t
				}), r(null);
			} catch (e) {
				r(e instanceof Error ? e : /* @__PURE__ */ Error("An error occurred"));
			} finally {
				t(!1);
			}
		})();
...
//#endregion
//#region src/assets/services/AssetLoader.ts
var ae = class e {
	static cache;
	static environment;
	static loadingQueue;
	constructor(t = x) {
		e.cache = /* @__PURE__ */ new Map(), e.environment = t, e.loadingQueue = /* @__PURE__ */ new Set();
	}
	static createAssetError(t, n, r) {
		return {
			name: "AssetError",
			message: t,
			code: r,
	...
	static async load(t, n, r = {}) {
		let i = `${n.id}-${n.version}-${e.environment}`;
		if (w[e.environment], r.cache !== !1) {
			let t = e.getCachedAsset(i, n);
			if (t) return t;
		}
		if (e.loadingQueue.has(i)) throw e.createAssetError("Asset is already being loaded", n.id, "ASSET_LOADING_DUPLICATE");
		e.loadingQueue.add(i);
		try {
			let a = t || n.cdnUrl || n.url, o = await e.fetchWithRetry(a, n, r), s = Buffer.from(await o.arrayBuffer());
			return e.cache.set(i, {
				data: s,
				metadata: {
					...n,
			...
			e.loadingQueue.delete(i);
		}
	}
	static async fetchWithRetry(t, n, r) {
		let i = r.retries ?? k.maxRetries, a = 0;
		for (; a < i;) try {
			let i = await fetch(t, {
				headers: {
					"If-None-Match": n.etag,
					"If-Modified-Since": new Date(n.lastModified).toUTCString()
				},
				signal: AbortSignal.timeout(r.timeout || k.defaultTimeout)
			});
			if (i.ok) return i;
			throw e.createAssetError(`Failed to load asset: ${i.statusText}`, n.id, `HTTP_${i.status}`);
		} catch (e) {
			if (a++, a === i) throw e;
			await new Promise((e) => setTimeout(e, k.retryDelay));
		}
		throw e.createAssetError("Max retries exceeded", n.id, "MAX_RETRIES_EXCEEDED");
	}
	static getCachedAsset(t, n) {
		let r = e.cache.get(t);
		return r ? Date.now() - r.metadata.lastModified > k.cacheDuration ? (e.cache.delete(t), null) : r.data : null;
	}
	static clearCache() {
		e.cache.clear();
	}
...
//#endregion
//#region src/assets/hooks/useAssetSystem.ts
var se = ({ category: e, tag: t, type: n = "All", assetName: r }) => {
	let [i, a] = (0, z.useState)([]), [o, s] = (0, z.useState)([]), [c, l] = (0, z.useState)(!0), [u, d] = (0, z.useState)(null), [f, p] = (0, z.useState)(null), m = V(), h = (0, z.useMemo)(() => {
		let n = i, r = o;
		return e && e !== "All" && (n = n.filter((t) => t.category === e), r = r.filter((t) => t.category === e)), t && (n = n.filter((e) => e.tags?.includes(t)), r = r.filter((e) => e.tags?.includes(t))), {
			backgrounds: n,
			overlays: r
		};
	}, [
	...
	return (0, z.useEffect)(() => {
		(async () => {
			try {
				n === "All" ? (a(await m.getAllBackgrounds()), s(await m.getAllOverlays())) : n === "background" || n === "backgrounds" ? a(await m.getAllBackgrounds()) : (n === "overlay" || n === "overlays") && s(await m.getAllOverlays());
			} catch (e) {
				d(e);
			} finally {
				l(!1);
		...
		r && (async () => {
			try {
				l(!0);
				let e = await m.getCached(r);
				if (!e) throw Error(`Asset ${r} not found`);
				p(await ae.load(e.url, e, { cache: !0 }));
			} catch (e) {
				d(e);
			} finally {
				l(!1);
	...
	var t = ce(), n = le(), r = { blocks: function(e) {
	...
	detectPixelArt(e) {
		let { width: t, height: n } = e.dims, r = t * n, i = /* @__PURE__ */ new Set(), a = 0;
		for (let t = 0; t < e.patch.length; t += 4) {
			if (e.patch[t + 3] === 0) {
				a++;
				continue;
			}
			i.add(`${e.patch[t]},${e.patch[t + 1]},${e.patch[t + 2]}`);
		}
		let o = i.size / (r - a), s = r <= 256 * 256, c = o <= .1, l = this.detectSharpEdges(e);
		return s && c && l;
	}
	detectSharpEdges(e) {
		let { width: t, height: n } = e.dims, r = 0, i = 0;
		for (let a = 1; a < n - 1; a++) for (let n = 1; n < t - 1; n++) {
			let o = (a * t + n) * 4, s = ((a - 1) * t + n) * 4, c = ((a + 1) * t + n) * 4, l = (a * t + (n - 1)) * 4, u = (a * t + (n + 1)) * 4;
			e.patch[o + 3] > 0 && (i++, (this.isSharpTransition(e.patch, o, s) || this.isSharpTransition(e.patch, o, c) || this.isSharpTransition(e.patch, o, l) || this.isSharpTransition(e.patch, o, u)) && r++);
		}
		return i > 0 && r / i > .4;
	}
	isSharpTransition(e, t, n) {
		return e[n + 3] === 0 ? !1 : Math.abs(e[t] - e[n]) > 32 || Math.abs(e[t + 1] - e[n + 1]) > 32 || Math.abs(e[t + 2] - e[n + 2]) > 32;
	}
	analyzePixelArtFrame(e) {
		let { width: t, height: n } = e.dims, r = t * n, i = /* @__PURE__ */ new Map(), a = 0, o = 0;
		for (let t = 0; t < e.patch.length; t += 4) {
			if (e.patch[t + 3] === 0) {
				a++;
				continue;
			...
			e.patch[t + 3] < 255 && o++;
			let n = `${e.patch[t]},${e.patch[t + 1]},${e.patch[t + 2]}`;
			i.set(n, (i.get(n) || 0) + 1);
		}
		let s = i.size, c = r - a, l = c > 0 ? s / c : 1, u = t <= 256 && n <= 256 && l < .1;
		return {
			...e,
			colors: s,
			uniqueColors: s,
			...
			uniqueRatio: l,
			isPixelArt: u,
			hasTransparency: a > 0 || o > 0,
			needsDisposal: o > 0 || a > 0 && a < r,
			disposalType: o > 0 ? 2 : 1
		};
	}
	processPixelArtFrame(e, t, n) {
		if (!e.dims || !e.patch) throw Error("Invalid frame data");
		let { maxWidth: r, maxHeight: i, scaleFactors: a } = t, o = Math.max(1, Math.floor(G.TARGET_SIZE / Math.max(r, i))), s = {
			width: e.dims.width,
			height: e.dims.height,
			top: e.dims.top || 0,
			left: e.dims.left || 0
		}, c = {
			width: Math.floor(s.width * o),
			height: Math.floor(s.height * o),
			targetWidth: Math.floor(r * o),
			targetHeight: Math.floor(i * o)
		}, l = {
			x: s.left * o,
			y: s.top * o
		};
		s.left === 0 && s.top === 0 && (l.x = Math.floor((c.targetWidth - c.width) / 2), l.y = Math.floor((c.targetHeight - c.height) / 2));
		let u = {
			x: Math.floor(l.x / o) * o,
			y: Math.floor(l.y / o) * o
		}, d = document.createElement("canvas");
		d.width = e.dims.width, d.height = e.dims.height;
		let f = d.getContext("2d", { alpha: !0 });
		if (!f) throw Error("Failed to get temp context");
		f.imageSmoothingEnabled = !1, f.imageSmoothingQuality = "low";
		let p = new ImageData(new Uint8ClampedArray(e.patch), e.dims.width, e.dims.height);
		f.putImageData(p, 0, 0);
		let m = document.createElement("canvas");
		m.width = c.targetWidth, m.height = c.targetHeight;
		let h = m.getContext("2d", { alpha: !0 });
		if (!h) throw Error("Failed to get output context");
		h.imageSmoothingEnabled = !1, h.imageSmoothingQuality = "low", h.drawImage(d, 0, 0, s.width, s.height, u.x, u.y, c.width, c.height);
		let g = h.getImageData(0, 0, c.targetWidth, c.targetHeight);
		return d.remove(), m.remove(), {
			...e,
			patch: g.data,
			dims: {
				width: c.targetWidth,
				height: c.targetHeight,
				top: 0,
				left: 0
			},
	...
	async analyzeImageFromGif(t) {
		let n = new Uint8Array(t);
		if (n.length >= 6 && (String.fromCharCode(...n.slice(0, 6)) === "GIF87a" || String.fromCharCode(...n.slice(0, 6)) === "GIF89a")) {
			let n = await e.instance.analyzeGIF(t), r = Math.max(1, 2 ** n.colorDepth), i = r / Math.max(1, n.width * n.height), a = this.extractDominantColorsFromGifMetadata(n);
			return {
				isPixelArt: n.isPixelArt,
				isAnimated: n.frames > 1,
				hasTransparency: n.hasTransparency,
				hasPartialTransparency: n.frameExtras.frameDelays.some((e) => e > 0) && n.frameExtras.frameColors.some((e) => e.size > 0),
				uniqueColorCount: r,
				colorDensityRatio: i,
				dominantColors: a,
				isFireLike: a.some((e) => e.frequency > .15 && e.r > e.g * 1.5 && e.r > e.b * 1.5 && e.r > 200),
				isHighRes: n.frameExtras.individualFrameSizes.some((e) => e.width * e.height > 512 * 512),
				hasVariableFrameSizes: n.frameExtras.individualFrameSizes.some((e) => e.width !== n.width || e.height !== n.height)
			};
		}
		return {
			isPixelArt: !1,
			isAnimated: !1,
			hasTransparency: !1,
			hasPartialTransparency: !1,
			uniqueColorCount: 0,
			colorDensityRatio: 0,
			isHighRes: !1,
			hasVariableFrameSizes: !1
		};
	}
	async detectPixelArtInAllFrames(e) {
		return e.some((e) => this.detectPixelArt(e));
	}
	extractDominantColorsFromGifMetadata(e) {
		let t = {};
		e.frameExtras.frameColors.forEach((e) => {
			e.forEach((e) => {
				let n = e.toString();
				t[n] = (t[n] || 0) + 1;
			});
		});
		let n = Object.values(t).reduce((e, t) => e + t, 0);
		...
		}).sort((e, t) => t.frequency - e.frequency).slice(0, 5);
	}
	detectPixelArt(e) {
		let { width: t, height: n } = e.dims, r = t * n, i = /* @__PURE__ */ new Set(), a = 0;
		for (let t = 0; t < e.patch.length; t += 4) {
			let n = e.patch[t], r = e.patch[t + 1], o = e.patch[t + 2];
			if (e.patch[t + 3] === 0) {
				a++;
				continue;
			}
		...
		let o = r - a, s = i.size / o, c = r <= 256 * 256, l = s <= .15, u = i.size <= 256;
		return c && (l || u);
	}
	async analyzeGIF(e) {
		let t = (0, W.parseGIF)(e), n = (0, W.decompressFrames)(t, !0), r = n.some((e) => e.dims.width * e.dims.height > 512 * 512), i = !1;
		i = n.some((e) => this.detectPixelArt(e));
		let a = !1, o = /* @__PURE__ */ new Set(), s = n.map((e) => {
			let t = K.prototype.analyzePixelArtFrame(e);
			a ||= t.hasTransparency;
			for (let t = 0; t < e.patch.length; t += 4) e.patch[t + 3] > 0 && o.add(`${e.patch[t]},${e.patch[t + 1]},${e.patch[t + 2]}`);
			return t;
		}), c = {
			frameDelays: n.map((e) => e.delay),
			individualFrameSizes: n.map((e) => ({
				width: e.dims.width,
				height: e.dims.height
			})),
			frameDisposal: n.map((e) => e.disposalType || 0),
			transparentIndex: n.map((e) => e.transparentIndex || -1),
			framePatch: n.map((e) => new Set(Array.from(e.patch))),
			frameColors: n.map((e) => {
				let t = /* @__PURE__ */ new Set();
				for (let n = 0; n < e.patch.length; n += 4) e.patch[n + 3] > 0 && t.add(e.patch[n] << 16 | e.patch[n + 1] << 8 | e.patch[n + 2]);
				return t;
			}),
			framePixels: n.map((e) => e.pixels || []),
			transparencyThresholds: s.map((e) => e.needsDisposal ? 220 : 128),
			isHighRes: r,
			averageAlpha: n.map((e) => {
				let t = 0, n = 0;
				for (let r = 3; r < e.patch.length; r += 4) e.patch[r] > 0 && (t += e.patch[r], n++);
				return n > 0 ? t / n : 255;
			})
		}, l = {
	...
	analyzeGIFFrameDimensions(e) {
		let t = e.map((e) => ({
			width: e.dims.width,
			height: e.dims.height
		})), n = Math.max(...t.map((e) => e.width)), r = Math.max(...t.map((e) => e.height));
		return {
			maxWidth: n,
			maxHeight: r,
			hasVariableSize: t.some((e) => e.width !== n || e.height !== r),
			scaleFactors: t.map((e) => {
				let t = n / e.width, i = r / e.height;
				return Math.min(t, i);
			})
		};
	}
}, q = he.getInstance(), J = class e {
	static instance = null;
	qualityOptions;
	constructor() {
		this.qualityOptions = { allowAutoDetect: !0 };
	}
	static getInstance() {
		return this.instance ||= new e(), this.instance;
	}
	...
	selectOptimalQuality(e) {
		if (this.qualityOptions.forceQuality) return this.qualityOptions.forceQuality;
		if (!this.qualityOptions.allowAutoDetect) return "HIGH";
		if (e.isPixelArt) return "PIXEL";
		let t = e.width * e.height, n = e.frameExtras.individualFrameSizes.reduce((e, t) => e + t.width * t.height, 0) / e.frames, r = t > 512 * 512 || n > 256 * 256, i = e.colorDepth > 128, a = e.frameExtras.frameColors.some((e) => e.size > 128);
		return this.analyzeDominantColors(e).isFireEffect && e.frames > 1 ? "FIRE" : r ? (i || a) && e.hasTransparency ? "HIGHRES" : "HIGH" : e.width * e.height > 1024 * 1024 ? e.hasTransparency ? "HIGHRES" : "HIGH" : e.colorDepth < 64 ? "LOW" : e.colorDepth < 128 ? "MEDIUM" : "HIGH";
	}
	selectQuality(e) {
		if (this.qualityOptions.forceQuality) return this.qualityOptions.forceQuality;
		let t = e.width * e.height, n = {
			isHighRes: t > 512 * 512,
		...
		}, r = this.analyzeDominantColors(e), i = this.detectFireMotion(e);
		return r.isFireEffect && i ? "FIRE" : e.isPixelArt ? n.isHighRes ? "HIGHRESPIXEL" : "PIXEL" : n.isHighRes || n.isVeryHighRes ? n.hasSharpEdges && n.hasLimitedPalette ? "HIGHRESPIXEL" : "HIGHRES" : (n.hasHighColorDepth || e.frames, "HIGH");
	}
	hasPixelArtCharacteristics(e) {
		let t = e.colorDepth < 128, n = e.frameExtras.frameColors.every((t) => t.size < e.width * e.height * .1);
		return t && n;
	}
	detectFireMotion(e) {
		let t = 0, n = e.frameExtras.frameColors;
		for (let e = 0; e < n.length - 1; e++) {
			let r = Array.from(n[e]), i = Array.from(n[e + 1]);
			r.filter((e, t) => {
				let n = e >> 16 & 255, r = i[t] >> 16 & 255;
				return Math.abs(n - r) > 20;
			}).length > r.length * .2 && t++;
		}
		return t > n.length * .5;
	}
	...
	async detectArtType(e) {
		return e.isPixelArt ? "PIXEL_ART" : e.width * e.height > 512 * 512 ? "HIGH_RES" : "STANDARD";
	}
	analyzeDominantColors(e) {
		let t = /* @__PURE__ */ new Map(), n = 0;
		e.frameExtras.frameColors.forEach((e) => {
			e.forEach((e) => {
				let r = `${e >> 16 & 255},${e >> 8 & 255},${e & 255}`;
				t.set(r, (t.get(r) || 0) + 1), n++;
			});
		});
		let r = Array.from(t.entries()).map(([e, t]) => {
			let [r, i, a] = e.split(",").map(Number);
			return {
				r,
				g: i,
		...
		return {
			isFireEffect: r.some((e) => e.frequency > .15 && e.r > e.g * 1.5 && e.r > e.b * 1.5 && e.r > 200),
			dominantColors: r
		};
	}
	detectSharpEdges(e) {
		return e.frameExtras.frameColors.some((e) => {
			let t = Array.from(e), n = 0;
			for (let e = 0; e < t.length - 1; e++) {
				let r = t[e], i = t[e + 1], a = r >> 16 & 255, o = r >> 8 & 255, s = r & 255, c = i >> 16 & 255, l = i >> 8 & 255, u = i & 255;
				(Math.abs(a - c) > 32 || Math.abs(o - l) > 32 || Math.abs(s - u) > 32) && n++;
			}
			return n > t.length * .3;
		});
	}
...
J.getInstance();
//#endregion
//#region src/analyzers/QualityAnalyzer.ts
var ge = class e {
	static instance = null;
	qualityManager;
	gifAnalyzer;
	...
	static getInstance() {
		return this.instance ||= new e(new J(), he.getInstance()), this.instance;
	}
	destroyInstance() {
		e.instance = null;
	}
	async analyzeGifQuality(e) {
		try {
			let t = await (await fetch(e)).arrayBuffer(), n = await this.gifAnalyzer.analyzeGIF(t);
			return {
				quality: this.qualityManager.selectOptimalQuality(n),
				metadata: n
			};
		} catch (e) {
			throw console.error("Error analyzing GIF quality:", e), e;
		}
	}
}, _e = class e {
	static instance = null;
	...
	constructor(e, t, n, r, i, a) {
		this.pixelArtHandler = e, this.imageProcessor = t, this.canvasPool = n, this.gifAnalyzer = r, this.workerPool = i, this.workerCount = a;
	}
	static getInstance(t, n, r, i, a, o) {
		return this.instance ||= new e(t, n, r, i, a, o), this.instance;
	}
	static destroyInstance() {
		this.instance = null;
	}
	calculateFrameSizeMetadata(e) {
		let { width: t, height: n, frames: r, isPixelArt: i } = e, a = e.frameExtras.individualFrameSizes, o = Math.max(...a.map((e) => e.width)), s = Math.max(...a.map((e) => e.height)), c = Math.min(...a.map((e) => e.width)), l = Math.min(...a.map((e) => e.height)), u = a.some((e) => e.width !== o || e.height !== s), d = a.map((e) => e.width / e.height);
		t / n;
		let f;
		if (i) {
			let e = Math.max(o, s), t = Math.floor(G.TARGET_SIZE / e);
			f = {
				width: o * t,
				height: s * t,
				scale: t
			...
			let e = G.TARGET_SIZE / Math.max(o, s);
			f = {
				width: Math.round(o * e),
	...
	calculateGifFitDimensions(e, t) {
		let n = G.TARGET_SIZE, r = e / t, i, a, o = 0, s = 0, c = e, l = t;
		return r > 1 ? (a = n, i = n, l = t, c = Math.round(t), o = Math.round((e - c) / 2)) : (i = n, a = n, c = e, l = Math.round(e), s = Math.round((t - l) / 2)), {
			width: i,
			height: a,
			x: 0,
			y: 0,
	...
	calculateConsistentDimensions(e) {
		let t = Math.max(...e.map((e) => e.dims.width)), n = Math.max(...e.map((e) => e.dims.height)), r = Math.min(G.TARGET_SIZE / t, G.TARGET_SIZE / n), i = Math.round(t * r), a = Math.round(n * r);
		return {
			width: i,
			height: a,
			scale: r,
			offsetX: Math.floor((G.TARGET_SIZE - i) / 2),
			offsetY: Math.floor((G.TARGET_SIZE - a) / 2)
		};
	}
	async processFrame(e, t) {
		try {
			let n = this.gifAnalyzer.detectPixelArt(e), { width: r, height: i } = e.dims;
			if (n) {
				let t = this.gifAnalyzer.analyzeGIFFrameDimensions([e]), n = this.pixelArtHandler.processPixelArtFrame(e, t, 0);
				return {
					bitmap: await createImageBitmap(new ImageData(new Uint8ClampedArray(n.patch), n.dims.width, n.dims.height)),
					originalFrame: n
				};
			}
			let a = this.canvasPool.getCanvas(r, i, !1), o = a.getContext("2d", { alpha: !0 });
			if (!o) throw Error("Failed to get canvas context");
			o.clearRect(0, 0, r, i), o.imageSmoothingEnabled = !n, o.imageSmoothingQuality = n ? "low" : "high";
			let s = new ImageData(new Uint8ClampedArray(e.patch), r, i);
			return o.putImageData(s, 0, 0), o.globalCompositeOperation = "source-over", t && o.drawImage(t, 0, 0, r, i), {
				bitmap: await createImageBitmap(a),
				originalFrame: e
			};
		} catch (e) {
			throw console.error("Error processing frame:", e), e;
		}
	}
	async processFrameOG(e) {
		try {
			this.gifAnalyzer.detectPixelArt(e);
			let { width: t, height: n } = e.dims, { width: r, height: i, x: a, y: o } = this.calculateGifFitDimensions(t, n), s = this.imageProcessor.createCanvas(r, i), c = this.imageProcessor.getCanvasContext(s);
			c.clearRect(0, 0, r, i), c.globalCompositeOperation = "source-over";
			let l = this.imageProcessor.createCanvas(t, n), u = this.imageProcessor.getCanvasContext(l), d = new ImageData(new Uint8ClampedArray(e.patch), t, n);
			for (let e = 3; e < d.data.length; e += 4) d.data[e] < 220 && (d.data[e] = 0);
			u.putImageData(d, 0, 0), c.drawImage(l, a, o, r, i);
			let f = c.getImageData(0, 0, s.width, s.height);
			return {
				...e,
				patch: f.data,
				dims: {
			...
			throw Error(`Failed to process frame: ${e}`);
		}
	}
	optimizeFrameDimensions(e, t) {
		let n = t.isPixelArt, { width: r, height: i } = e.dims;
		if (n) {
			let e = Math.max(pe.minimumPixelSize, Math.floor(G.TARGET_SIZE / Math.max(r, i))), t = Math.min(e, pe.maxScale);
			return {
				width: r * t,
				height: i * t,
				scale: t,
				offsetX: Math.floor((G.TARGET_SIZE - r * t) / 2),
				offsetY: Math.floor((G.TARGET_SIZE - i * t) / 2)
			};
		}
		return Math.min(G.TARGET_SIZE / r, G.TARGET_SIZE / i), this.calculateConsistentDimensions([e]);
	}
	async processFrame1(e, t, n) {
		if (!n) return e;
		let { width: r, height: i, sourceX: a, sourceY: o } = this.calculateGifFitDimensions(e.dims.width, e.dims.height), s = this.calculateFrameSizeMetadata(n);
		n.isPixelArt;
		let c = document.createElement("canvas");
		c.width = s.targetSize.width, c.height = s.targetSize.height;
		let l = c.getContext("2d", { alpha: !0 });
		if (!l) throw Error("Failed to get canvas context");
		let { width: u, height: d, scale: f } = this.imageProcessor.calculateUniformDimensions(n);
		if (l) {
			l.imageSmoothingEnabled = !1, c instanceof HTMLCanvasElement && (c.style.imageRendering = "pixelated");
			let t = (u - e.dims.width * f) / 2, n = (d - e.dims.height * f) / 2, r = document.createElement("canvas");
			r.width = e.dims.width, r.height = e.dims.height;
			let i = r.getContext("2d", { alpha: !0 });
			if (!i) throw Error("Failed to get temp context");
			i.putImageData(new ImageData(new Uint8ClampedArray(e.patch), e.dims.width, e.dims.height), 0, 0), l.drawImage(r, t, n, e.dims.width * f, e.dims.height * f);
		}
		l.clearRect(0, 0, c.width, c.height);
		let p = e.dims.width * s.targetSize.scale, m = e.dims.height * s.targetSize.scale, h = (s.targetSize.width - p) / 2, g = (s.targetSize.height - m) / 2, _ = document.createElement("canvas");
		_.width = e.dims.width, _.height = e.dims.height;
		let v = _.getContext("2d", { alpha: !0 });
		if (!v) throw Error("Failed to get temp context");
		v.putImageData(new ImageData(new Uint8ClampedArray(e.patch), e.dims.width, e.dims.height), 0, 0), l.drawImage(_, h, g, p, m);
		let y = l.getImageData(0, 0, c.width, c.height);
		return {
			...e,
			patch: y.data,
			dims: {
	...
	processHighResFrame(e, t) {
		let { width: n, height: r } = e.dims, i = document.createElement("canvas");
		i.width = n, i.height = r;
		let a = i.getContext("2d", { alpha: !0 });
		if (!a) throw Error("Failed to get alpha context");
		let o = new ImageData(new Uint8ClampedArray(e.patch), n, r);
		for (let e = 3; e < o.data.length; e += 4) o.data[e] > 0 && o.data[e] < 255 || o.data[e] === 0 && (o.data[e - 3] = 0, o.data[e - 2] = 0, o.data[e - 1] = 0);
		a.putImageData(o, 0, 0);
		let { width: s, height: c } = this.calculateGifFitDimensions(n, r), l = document.createElement("canvas");
		l.width = s, l.height = c;
		let u = l.getContext("2d", { alpha: !0 });
		if (!u) throw Error("Failed to get output context");
		u.imageSmoothingEnabled = !0, u.imageSmoothingQuality = "high", u.drawImage(i, 0, 0, s, c);
		let d = u.getImageData(0, 0, s, c);
		return i.remove(), l.remove(), {
			...e,
			patch: d.data,
			dims: {
				width: s,
	...
	async processFramesInWorkers(e, t) {
		...
		let n = Math.ceil(e.length / this.workerCount), r = [];
		for (let t = 0; t < e.length; t += n) r.push(e.slice(t, t + n));
		return (await Promise.all(r.map(async (e) => this.workerPool.addTask(() => Promise.all(e.map(async (e) => this.processFrame(e, t ?? null))))))).flat();
	}
}, ve = class e {
	static instance = null;
	qualityOptions;
	...
	selectOptimalQuality(e) {
		let t = this.extractCharacteristics(e);
		if (!this.qualityOptions.allowAutoDetect) return this.qualityOptions.checkQuality;
		if (t.format === "gif") {
			if (t.type === "ANIMATION") return "HIGH";
			if (t.type === "image") return "PIXEL";
		}
		return t.format === "png" && t.type === "image" ? "HIGHRES" : t.format === "jpg" && t.type === "image" ? "HIGHRESPIXEL" : "HIGH";
	}
	static getInstance() {
		return this.instance ||= new e(), this.instance;
	}
	...
	significantOperations = new Set(["processing", "encoding"]);
	constructor() {
		this.progressDebouncer = new ye((e) => {
			window.dispatchEvent(new CustomEvent("gif-phase-update", { detail: e }));
		}), this.initialized ||= (this.initializePhases(), !0);
	}
	initializePhases() {
	...
	trackFrameProcessing(e, t) {
		...
		e === 0 && (this.frameStartTime = n, this.frameProcessingTimes = [], this.totalFramesCount = t, this.processedFramesCount = 0, this.processingStartTime = n);
		let r = n - this.frameStartTime;
		this.frameProcessingTimes.push(r), this.processedFramesCount++;
		let i = this.frameProcessingTimes.slice(-5), a = i.reduce((e, t) => e + t, 0) / i.length, o = (t - (e + 1)) * a;
		return this.frameStartTime = n, {
			progress: Math.round((e + 1) / t * 100),
			estimatedRemainingTime: o,
			avgTimePerFrame: a,
			elapsedTime: n - this.processingStartTime
		};
	}
	updateLoadingProgress(e, t, n) {
		let r = Math.round(e / t * 100);
		this.updatePhase(X.LOADING.id, r, `Loading assets (${e}/${t}): ${n.split("/").pop()}`);
	}
	calculateETA(e, t) {
		let n = performance.now(), r = n - this.processingStartTime;
		if (e === 0) return this.processingStartTime = n, "Calculating...";
		this.framesProcessed = e, this.averageFrameTime = r / e;
		let i = (t - e) * this.averageFrameTime;
		if (i < 1e3) return "Less than a second";
		let a = Math.round(i / 1e3);
		if (a < 60) return `~${a} seconds`;
		let o = Math.round(a / 60);
		return `~${o} minute${o > 1 ? "s" : ""}`;
	}
	resetProgress(e) {
		if (e) {
			let t = X[e];
		...
		} else Object.values(this.phases).some((e) => e.progress !== 0 || e.processed !== 0 || e.total !== 0 || e.status !== "pending") && this.initializePhases();
	}
	updatePhase(e, t, n, r = "processing", i, a, o) {
		if (!this.significantOperations.has(r)) return;
		let s = performance.now();
		this.phaseStartTimes.has(e) || this.phaseStartTimes.set(e, s);
		let c = s - (this.phaseStartTimes.get(e) || s), l = this.processedFramesCount ? c / this.processedFramesCount : 0, u = a ? (a - this.processedFramesCount) * l : 0, d = {
			phaseId: e,
			currentProgress: t,
			message: n,
			operation: r,
			...
			timestamp: s,
			totalItems: a,
			estimatedRemainingTime: o || u,
			elapsedTime: c,
			speed: l,
			processed: this.processedFramesCount,
			total: a || this.totalFramesCount,
			isCompleted: t >= 100
		};
		this.progressDebouncer.update(d), t >= 100 && this.completedPhases.add(e), Object.values(X).forEach((t) => {
			t.id !== e && !this.completedPhases.has(t.id) && Object.values(X).indexOf(t) < Object.values(X).findIndex((t) => t.id === e) && (this.completedPhases.add(t.id), window.dispatchEvent(new CustomEvent("gif-phase-update", { detail: {
				phaseId: t.id,
				currentProgress: 100,
				message: `${t.name} complete`,
				timestamp: s
			} })));
	...
	calculateTotalProgress() {
		let e = 0, t = !1;
		for (let n of this.phaseOrder) {
			let r = this.phases[n];
			if (r.status === "completed" ? e += r.weight : r.status === "active" && !t && (e += (r.progress ?? 0) * r.weight / 100, t = !0), t) break;
		}
		let n = this.phaseOrder.reduce((e, t) => e + this.phases[t].weight, 0);
		return n > 0 ? Math.round(e / n * 100) : 0;
	}
	startTracking() {
		this.startTime = Date.now(), this.reset();
	}
	updatePhaseProgress(e, t, n) {
		let r = this.phases[e];
		r && (r.progress = t, r.message = n || "", this.emitProgress({
			phase: e,
			phaseProgress: t,
	...
	progressDebouncer;
	constructor() {
		super(X, xe), this.startTime = Date.now(), this.progressDebouncer = new ye((e) => {
			this.emitProgress(e);
		});
	}
	updateProgress(e, t, n, r, i, a) {
		let o = Date.now();
		if (!this.phases[e]) {
		...
		if (this.phaseTimings.has(e) || this.phaseTimings.set(e, { start: o }), e !== this.currentPhase) {
			if (this.currentPhase) {
				let e = this.phaseTimings.get(this.currentPhase);
				e && (e.end = o, this.phaseTimings.set(this.currentPhase, e));
			}
			this.currentPhase = e;
		}
		let s = this.phases[e];
		if (!s) return;
		s.status = "active", s.progress = Math.min(100, Math.max(0, t)), s.message = n || s.message, s.startTime = this.phaseTimings.get(e)?.start, s.totalItems = r, s.processedItems = i, e === "encoding" && this.handleEncodingPhase(t, o, r, i);
		let c = this.calculatePhaseElapsed(e, o), l = o - this.startTime, u = this.calculateProcessingSpeed(e, i, c), d = this.calculateEta(e, i, r, c);
		this.progressDebouncer.update({
			...
			totalItems: r,
			processedItems: i,
			estimatedRemainingTime: d,
			elapsedTime: l,
			isActive: !0,
			processingSpeed: u
		}), t >= 100 && this.completePhase(e, o).then(() => {
			this.updateProgress(e, 0, n, r, i, a);
		});
	}
	handleEncodingPhase(e, t, n, r) {
		this.encodingStartTime || (this.encodingStartTime = t, this.frameCount = n || 0), this.processedFrames = r || 0;
	}
	calculatePhaseElapsed(e, t) {
		let n = this.phaseTimings.get(e);
		return n ? t - n.start : 0;
	}
	calculateProcessingSpeed(e, t, n) {
		if (!t || !n) return "";
		let r = t / n * 1e3;
		return e === "encoding" ? `${r.toFixed(1)} fps` : `${r.toFixed(1)}/s`;
	}
	calculateEta(e, t, n, r) {
		if (!t || !n || !r) return 0;
		let i = t / r;
		return (n - t) / i;
	}
	async completePhase(e, t = Date.now()) {
		let n = this.phases[e];
		if (!n) return;
		let r = this.phaseTimings.get(e);
		r && (r.end = t, this.phaseTimings.set(e, r)), n.status = "completed", n.progress = 100, n.endTime = t, n.duration = r ? r.end - r.start : 0, this.completedPhases.add(e);
		let i = this.phaseOrder.indexOf(e) + 1;
		if (i < this.phaseOrder.length) {
			let e = this.phaseOrder[i];
			this.phaseTimings.set(e, { start: t });
		}
	}
	getTotalElapsedTime() {
	...
	canvasPool;
	constructor(e, t, n) {
		this.progManager = e, this.workerPool = t, this.canvasPool = n, this.completedPhases = /* @__PURE__ */ new Set();
	}
	static getInstance(t, n, r) {
		return this.instance ||= new e(t, n, r), this.instance;
	}
	static destroyInstance() {
		this.instance = null;
	}
	async loadAndCreateStaticImage(e, t) {
		try {
			this.progManager.updatePhase(X.CREATE_STATIC.id, 0, "Loading background image...", "processing", e);
			let n = await this.loadImage(e);
			this.progManager.updatePhase(X.CREATE_STATIC.id, 20, "Background loaded");
			let r = document.createElement("canvas");
			r.width = G.TARGET_SIZE, r.height = G.TARGET_SIZE;
			let i = r.getContext("2d", { willReadFrequently: !0 });
			if (!i) throw Error("Failed to get canvas context");
			let a = Math.min(G.TARGET_SIZE / G.NFT_SIZE, G.TARGET_SIZE / G.NFT_SIZE), o = Math.round(G.NFT_SIZE * a), s = Math.round(G.NFT_SIZE * a), c = this.calculateCenteredPosition(G.TARGET_SIZE, o), l = this.calculateCenteredPosition(G.TARGET_SIZE, s);
			if (i.drawImage(n, c, l, o, s), t?.length) for (let e = 0; e < t.length; e++) {
				let n = t[e];
				this.progManager.updatePhase(X.CREATE_STATIC.id, 20 + Math.round((e + 1) / t.length * 80), `Loading overlay ${e + 1}/${t.length}`, "processing", n.name);
				let r = await this.loadImage(n.url);
				i.drawImage(r, c, l, o, s);
			}
			return this.progManager.updatePhase(X.CREATE_STATIC.id, 100, "Static layer complete"), r;
		} catch (e) {
			throw console.error("Error creating static image:", e), e;
		}
	}
	getCacheKey(e) {
		return e;
	...
	optimizeGifFrame(e, t = !1) {
		...
		n.width = G.TARGET_SIZE, n.height = G.TARGET_SIZE;
		let r = n.getContext("2d", {
			willReadFrequently: !0,
			alpha: !0
		});
		return r && (r.imageSmoothingEnabled = !0, r.imageSmoothingQuality = "high", r.globalCompositeOperation = "copy", r.drawImage(e, 0, 0, n.width, n.height)), n;
	}
	async logBatchProgress(e, t, n) {
		let r = e, i = Math.min(e + t, n), a = this.workerPool.stats;
		console.debug(`[BatchProcessor] Progress:
        Batch: ${Math.floor(e / t) + 1}/${Math.ceil(n / t)}
        Workers: ${a.activeWorkers}/${a.maxWorkers} (${a.availableWorkers} available)
        Memory: ${Math.round(this.memoryUsage.usedJSHeapSize / (1024 * 1024))}MB
        Frames: ${r + 1}-${i}/${n}
      `), i === n && this.progManager.updatePhase(X.PROCESSING.id, 100, "Frame processing complete");
	}
	loadedAssetCount = 0;
	loadWithProgress = async (e, t) => {
		try {
			...
			let r = Math.round(this.loadedAssetCount / t * 100);
			return this.progManager.updatePhase(X.LOADING.id, r, `Loading asset ${this.loadedAssetCount}/${t}: ${e}`), n;
		} catch (e) {
			throw console.error("Asset loading failed:", e), e;
		} finally {
	...
	async loadAsset(e) {
		let t = e.length || 0;
		return await Promise.all(e?.map(async (e) => await this.loadWithProgress(e.url, t)) || []);
	}
	async loadAssets(e, t) {
		let n = (t?.length || 0) + 1, r = 0;
		try {
			this.progManager.updatePhase(X.LOADING.id, 0, "Starting asset load...");
			let i = await this.loadImage(e);
			r++;
			let a = r / n * 100;
			if (this.progManager.updatePhase(X.LOADING.id, a, "Base image loaded", "processing", e), !t?.length) return this.progManager.updatePhase(X.LOADING.id, 100, "Assets loaded"), this.completedPhases.add(X.LOADING.id), {
				bglessImage: i,
				overlayImages: []
			};
			let o = await Promise.all(t.map(async (e, i) => {
				let a = await this.loadImage(e.url);
				r++;
				let o = r / n * 100;
				return this.progManager.updatePhase(X.LOADING.id, o, `Loading OverlayAsset ${i + 1}/${t.length}`, "processing", e.name), a;
			}));
			return this.progManager.updatePhase(X.LOADING.id, 100, "All assets loaded"), this.completedPhases.add(X.LOADING.id), {
				bglessImage: i,
				overlayImages: o
			};
		} catch (e) {
			throw console.error("Asset loading failed:", e), this.completedPhases.delete(X.LOADING.id), e;
		}
	}
	async loadImage(e) {
		return new Promise((t, n) => {
			let r = new Image();
			r.crossOrigin = "anonymous", r.onload = () => t(r), r.onerror = (t) => {
				console.error(`Failed to load image: ${e}`, t), n(/* @__PURE__ */ Error(`Failed to load image: ${e}`));
			}, r.src = e;
		});
	}
	...
	drawOverlay(e, t, n, r) {
		let { x: i, y: a } = n;
		if (r) {
			let { width: n, height: o } = r;
			e.drawImage(t, i, a, n, o);
		} else e.drawImage(t, i, a);
	}
	loadStaticImage = async (e, t) => {
		`${Date.now()}`;
		try {
			if (!t) {
				this.progManager.updatePhase(X.LOADING.id, 0, "Loading base image...");
				let t = await this.loadImage(e);
				return this.progManager.updatePhase(X.LOADING.id, 100, "Base image loaded"), this.createStaticImage(t);
			}
			let n = t.length + 1;
			this.progManager.updatePhase(X.LOADING.id, 0, "Loading assets...");
			let r = await this.loadImage(e);
			this.progManager.updatePhase(X.LOADING.id, 1 / n * 100, "Base image loaded");
			let i = await Promise.all(t.map(async (e, r) => {
				let i = await this.loadImage(e.url), a = (r + 2) / n * 100;
				return this.progManager.updatePhase(X.LOADING.id, a, `Loading overlay ${r + 1}/${t.length}`), i;
			}));
			return this.progManager.updatePhase(X.LOADING.id, 100, "All assets loaded"), this.createStaticImage(r, i);
		} catch (e) {
			throw console.error("Failed to load static image:", e), e;
		}
	};
	async createStaticImage(e, t) {
		if (!e) throw Error("No images provided for creating a static image.");
		if (!t?.length) {
			let t = this.canvasPool.getCanvas(e.width, e.height, !1), n = t.getContext("2d", { willReadFrequently: !0 });
			if (!n) throw Error("Failed to get canvas context for static image.");
			return n.drawImage(e, 0, 0, e.width, e.height), t;
		}
		let n = e?.width || G.MAX_CANVAS_SIZE, r = e?.height || G.MAX_CANVAS_SIZE, i = this.canvasPool.getCanvas(n, r, !1), a = i.getContext("2d", { willReadFrequently: !0 });
		if (!a) throw Error("Failed to get canvas context for static image.");
		i.width = n, i.height = r;
		let o = await Promise.all(t.map(async (e) => ({
			...e,
			image: await this.loadImage(e.src).catch((t) => (console.error(`Failed to load overlay image: ${e.src}`, t), null))
		})));
		return await this.workerPool.addTask(async () => {
			e && a.drawImage(e, 0, 0, n, r);
			for (let e of o) e.image && this.drawOverlay(a, e.image, {
				x: e.x,
				y: e.y
			}, e.width ? {
				width: e.width,
...
}, we = Ce.getInstance(new Y(), t.getInstance(), e.getInstance()), Te = "gif.process-frame", Ee = "gif.encode", De = class e {
	static instance = null;
	workerPool;
	isInitialized = !1;
	...
	async initialize() {
		this.isInitialized ||= (await this.workerPool.initialize(), await this.registerWorkerTasks(), !0);
	}
	async processFrameInWorker(e) {
		return this.isInitialized || await this.initialize(), this.workerPool.runTask(Te, e, 3e4);
	}
	cleanupWorker(e) {
	...
	handleWorkerMessage(e, t) {
		let n = this.workerPool.executingTasks.get(e);
		n && (clearTimeout(n.timeoutId), this.workerPool.executingTasks.delete(e), this.workerPool.markWorkerAvailable(e), t.data.type === "success" ? n.resolve(t.data.result) : t.data.type === "error" && n.reject(Error(t.data.error)));
	}
	async encodeGIFInWorker(e) {
		return this.isInitialized || await this.initialize(), this.workerPool.runTask(Ee, e, 3e4);
	}
	async registerWorkerTasks() {
		this.workerPool.hasTask(Te) || await this.workerPool.registerTask(Te, async (e) => this.dispatchToBrowserWorker({
			type: "processFrame",
			frame: e
		})), this.workerPool.hasTask(Ee) || await this.workerPool.registerTask(Ee, async (e) => this.dispatchToBrowserWorker(e));
	}
	async dispatchToBrowserWorker(e) {
		return new Promise((t, n) => {
			let r = new Worker(G.WORKER_PATH);
			this.activeWorkers.add(r), r.onmessage = (e) => {
				t(e.data), this.cleanupWorker(r);
			}, r.onerror = (e) => {
				n(e), this.cleanupWorker(r);
			}, r.postMessage(e);
		});
	}
}, Oe = class e {
	...
	constructor(t, n, r, i, a, o, s) {
		e.sessionId = t, this.progTracker = n, this.workerCount = s, this.cache = /* @__PURE__ */ new Map(), this.currentMemoryStrategy = this.MEMORY_STRATEGIES.MEDIUM, this.qualityOptions = o, this.workerPool = i, this.gifWorkerPool = a, this.processedFramesCache = /* @__PURE__ */ new Map(), this.isProcessing = !1, this.abort = new AbortController();
	}
	static getInstance(t, n, r, i, a, o, s) {
		return this.instance ||= new e(t, n, r, i, a, o, s), this.instance;
	}
	static destroyInstance() {
		this.instance = null;
	}
	...
	async handleMemoryPressure(e) {
		let t = e / (performance?.memory?.jsHeapSizeLimit || 2048 * 1024 * 1024);
		t > this.currentMemoryStrategy.cleanupThreshold && t > .9 && (this.currentMemoryStrategy = this.MEMORY_STRATEGIES.LOW, this.workerCount = this.currentMemoryStrategy.workerCount);
	}
	async cleanup() {
	...
	validateInput(e, t, n) {
		if (!e?.length) throw Error("No frames provided");
		if (!t) throw Error("No background image URL provided");
		if (n !== void 0 && !Array.isArray(n)) throw Error("Invalid overlays format");
	}
	async cancel() {
...
}, ke = (e = 21) => crypto.getRandomValues(new Uint8Array(e)).reduce((e, t) => (t &= 63, t < 36 ? e += t.toString(36) : t < 62 ? e += (t - 26).toString(36).toUpperCase() : t > 62 ? e += "-" : e += "_", e), ""), Ae = class e {
	static instance = null;
...
Ae.getInstance();
//#endregion
//#region src/services/ImageProcessingServicev1.ts
var je = class e {
	static instance = null;
	workerCount;
	pixelArtHandler;
	gifAnalyzer;
	constructor(e, t, n) {
		this.workerCount = e, this.pixelArtHandler = t, this.gifAnalyzer = n;
	}
	static getInstance(t, n, r) {
		return this.instance ||= new e(t, n, r), this.instance;
	}
	...
	enhanceColorTable(e, t, n) {
		let r = fe[n];
		return e.map((e) => {
			let [i, a, o] = e;
			if (n === "FIRE" && t && i > a && i > o) return [
				Math.min(255, i * 1.2),
				a * .9,
				o * .8
			];
	...
	async createImgBitmap(e, t) {
		let n = await this.gifAnalyzer.detectPixelArtInAllFrames(e);
		if (n) {
			let t = this.gifAnalyzer.analyzeGIFFrameDimensions(e);
			e = e.map((e, n) => this.pixelArtHandler.processPixelArtFrame(e, t, n));
		}
		let r = document.createElement("canvas");
		r.width = G.TARGET_SIZE, r.height = G.TARGET_SIZE;
		...
		if (!i) throw Error("Failed to get buffer context");
		return Promise.all(e.map(async (e, a) => {
			let { width: o, height: s, left: c, top: l } = e.dims, u = document.createElement("canvas");
			u.width = o, u.height = s;
			let d = u.getContext("2d", {
				alpha: !0,
				willReadFrequently: !0
			});
			if (!d) throw Error("Failed to get frame context");
			d.putImageData(new ImageData(this.normalizePatchForImageData(e.patch), o, s), 0, 0);
			let f = document.createElement("canvas");
			f.width = G.TARGET_SIZE, f.height = G.TARGET_SIZE;
			let p = f.getContext("2d", {
				alpha: !0,
				willReadFrequently: !0
			});
			if (!p) throw Error("Failed to get composite context");
			e.disposalType === 2 ? p.clearRect(0, 0, f.width, f.height) : p.drawImage(r, 0, 0), n ? (p.imageSmoothingEnabled = !1, p.drawImage(u, c, l, o, s)) : (p.imageSmoothingEnabled = !0, p.imageSmoothingQuality = "high", p.drawImage(u, c, l, o, s)), t && (p.globalCompositeOperation = "source-over", p.drawImage(t, 0, 0, G.TARGET_SIZE, G.TARGET_SIZE)), i.clearRect(0, 0, r.width, r.height), i.drawImage(f, 0, 0);
			try {
				return {
	...
	getCanvasContext(e) {
		...
		if (!t) throw Error("Failed to get canvas context");
		return t;
	}
	scaleFramePatch(e, t) {
		let n = this.createCanvas(e.dims.width, e.dims.height), r = this.getCanvasContext(n), i = new ImageData(this.normalizePatchForImageData(e.patch), e.dims.width, e.dims.height);
		if (r.putImageData(i, 0, 0), t.drawImage(n, 0, 0, G.TARGET_SIZE, G.TARGET_SIZE), n instanceof OffscreenCanvas) {
			let e = document.createElement("canvas");
			e.width = n.width, e.height = n.height;
			let t = e.getContext("2d", { willReadFrequently: !0 });
			if (t) return t.drawImage(n, 0, 0), e;
		}
		return n;
	}
	overlayStaticImage(e, t) {
		e.globalCompositeOperation = "source-over", e.drawImage(t, 0, 0, G.TARGET_SIZE, G.TARGET_SIZE);
	}
	async preOptimizeGifFrame(e, t = !1, n = "HIGH") {
		let r = K.prototype.analyzePixelArtFrame(e);
		if (r.isPixelArt) return {
			...e,
			patch: e.patch,
		...
		let i = { ...fe[n] };
		r.hasTransparency && (i.preserveAlpha = !0, i.alphaThreshold = r.needsDisposal ? 220 : 128, i.disposalMethod = r.needsDisposal ? 2 : 1);
		let a = await this.optimizePatch(e.patch, e.transparentIndex, n, r);
		if (!t || !e.colorTable) return {
			...e,
			patch: a
		};
		let o = this.enhanceColorTable(e.colorTable, t, n);
		return {
			...e,
			colorTable: o,
			patch: a,
			disposalType: e.disposalType ? e.disposalType : i?.disposalMethod ? i.disposalMethod : 2
		};
	}
	calculateUniformDimensions(e) {
		let t = e.frameExtras.individualFrameSizes, n = Math.max(...t.map((e) => e.width)), r = Math.max(...t.map((e) => e.height)), i = Math.min(G.TARGET_SIZE / n, G.TARGET_SIZE / r);
		return {
			width: Math.round(n * i),
			height: Math.round(r * i),
			scale: i
		};
	}
	async optimizePatch(e, t, n, r) {
		let i = fe[n], a = Math.ceil(e.length / (this.workerCount * 4)) * 4, o = [];
		for (let t = 0; t < e.length; t += a) o.push(e.subarray(t, Math.min(t + a, e.length)));
		let s = await Promise.all(o.map((e) => this.processChunk(e, t, i, r))), c = new Uint8ClampedArray(e.length), l = 0;
		for (let e of s) c.set(e, l), l += e.length;
		return c;
	}
	processChunk(e, t, n, r) {
		let i = new Uint8ClampedArray(e.length);
		if (r.isPixelArt) return i.set(e), i;
		let { colorEnhancement: a } = n;
		for (let n = 0; n < e.length; n += 4) {
			let r = e[n + 3], o = e[n], s = e[n + 1], c = e[n + 2];
			r < 220 || t === o ? (i[n] = 0, i[n + 1] = 0, i[n + 2] = 0, i[n + 3] = 0) : (i[n] = Math.min(255, o * (a?.red ?? 1)), i[n + 1] = Math.min(255, s * (a?.green ?? 1)), i[n + 2] = Math.min(255, c * (a?.blue ?? 1)), i[n + 3] = 255);
		}
		return i;
	}
}, Me = class {
	...
	delay;
	backoffFactor;
	constructor(e = 3, t = 500, n = 2) {
		this.retries = e, this.delay = t, this.backoffFactor = n;
	}
	async execute(e) {
		let t = 0, n = this.delay;
		for (; t < this.retries;) try {
			return await e();
		} catch (e) {
			if (t++, t >= this.retries) throw e;
			await this.delayExecution(n), n *= this.backoffFactor;
		}
		throw Error("RetryHandler exhausted all retries");
	}
	delayExecution(e) {
	...
	jitterFactor;
	constructor(e = 3, t = 500, n = 2, r = .1) {
		super(e, t, n), this.jitterFactor = r;
	}
	applyJitter(e) {
		return e + e * this.jitterFactor * (Math.random() - .5);
	}
	async execute(e) {
		let t = 0, n = this.delay;
		for (; t < this.retries;) try {
			...
			if (t++, t >= this.retries) throw e;
			let r = this.applyJitter(n);
			await this.delayExecution(r), n *= this.backoffFactor;
		}
		throw Error("EnhancedRetryHandler exhausted all retries");
	}
};
async function Pe(e, t, n = 3, r = 500) {
	return new Me(n, r).execute(() => fetch(e, t));
}
//#endregion
//#region src/GifProcessor/index.ts
var Fe = /* @__PURE__ */ p((/* @__PURE__ */ u(((e, t) => {
	(function(n, r) {
		typeof e == "object" && typeof t == "object" ? t.exports = r() : typeof define == "function" && define.amd ? define([], r) : typeof e == "object" ? e.GIF = r() : n.GIF = r();
	})(e, function() {
		return function(e) {
			function t(r) {
			...
			function(e, t, n) {
				...
				}, o = {}.hasOwnProperty, s = [].indexOf || function(e) {
					for (var t = 0, n = this.length; t < n; t++) if (t in this && this[t] === e) return t;
					return -1;
				};
				r = n(1).EventEmitter, n(2), i = function(e) {
					function t(e) {
						var t, r, i;
						for (r in this.running = !1, this.options = {}, this.frames = [], this.groups = /* @__PURE__ */ new Map(), this.freeWorkers = [], this.activeWorkers = [], this.setOptions(e), n) i = n[r], (t = this.options)[r] ?? (t[r] = i);
					}
					var n, r;
					return a(t, e), n = {
						...
						if (this.options[e] = t, this._canvas != null && (e === "width" || e === "height")) return this._canvas[e] = t;
					}, t.prototype.setOptions = function(e) {
						var t, n = [], r;
						for (t in e) o.call(e, t) && (r = e[t], n.push(this.setOption(t, r)));
						return n;
					}, t.prototype.addFrame = function(e, t) {
						var n, i, a;
						for (a in t ??= {}, n = {}, n.transparent = this.options.transparent, r) n[a] = t[a] || r[a];
						if (this.options.width ?? this.setOption("width", e.width), this.options.height ?? this.setOption("height", e.height), typeof ImageData < "u" && ImageData !== null && e instanceof ImageData) n.data = e.data;
						else if (typeof CanvasRenderingContext2D < "u" && CanvasRenderingContext2D !== null && e instanceof CanvasRenderingContext2D || typeof WebGLRenderingContext < "u" && WebGLRenderingContext !== null && e instanceof WebGLRenderingContext) t.copy ? n.data = this.getContextData(e) : n.context = e;
						else {
							if (e.childNodes == null) throw Error("Invalid image");
							t.copy ? n.data = this.getImageData(e) : n.image = e;
						}
						return i = this.frames.length, i > 0 && n.data && (this.groups.has(n.data) ? this.groups.get(n.data).push(i) : this.groups.set(n.data, [i])), this.frames.push(n);
					}, t.prototype.render = function() {
						var e, t, n;
						if (this.running) throw Error("Already running");
						if (this.options.width == null || this.options.height == null) throw Error("Width and height must be set prior to rendering");
						if (this.running = !0, this.nextFrame = 0, this.finishedFrames = 0, this.imageParts = function() {
							...
							return n;
						}.call(this), t = this.spawnWorkers(), this.options.globalPalette === !0) this.renderNextFrame();
						else for (e = 0, n = t; 0 <= n ? e < n : e > n; 0 <= n ? ++e : --e) this.renderNextFrame();
						...
						return e = Math.min(this.options.workers, this.frames.length), function() {
							...
							return function(t) {
								var n;
								return e.log("spawning worker " + t), n = new Worker(e.options.workerScript), n.onmessage = function(t) {
									return e.activeWorkers.splice(e.activeWorkers.indexOf(n), 1), e.freeWorkers.push(n), e.frameFinished(t.data, !1);
								}, e.freeWorkers.push(n);
							};
						}(this)), e;
					}, t.prototype.frameFinished = function(e, t) {
						var n, r, i, a;
						if (this.finishedFrames++, t ? (n = this.frames.indexOf(e), r = this.groups.get(e.data)[0], this.log("frame " + (n + 1) + " is duplicate of " + r + " - " + this.activeWorkers.length + " active"), this.imageParts[n] = { indexOfFirstInGroup: r }) : (this.log("frame " + (e.index + 1) + " finished - " + this.activeWorkers.length + " active"), this.emit("progress", this.finishedFrames / this.frames.length), this.imageParts[e.index] = e), this.options.globalPalette === !0 && !t && (this.options.globalPalette = e.globalPalette, this.log("global palette analyzed"), this.frames.length > 2)) for (i = 1, a = this.freeWorkers.length; 1 <= a ? i < a : i > a; 1 <= a ? ++i : --i) this.renderNextFrame();
						return s.call(this.imageParts, null) >= 0 ? this.renderNextFrame() : this.finishRendering();
					}, t.prototype.finishRendering = function() {
						var e, t, n, r, i, a, o, s, c, l, u, d, f, p, m, h, g, _, v, y;
						for (g = this.imageParts, i = a = 0, l = g.length; a < l; i = ++a) t = g[i], t.indexOfFirstInGroup && (this.imageParts[i] = this.imageParts[t.indexOfFirstInGroup]);
						for (c = 0, _ = this.imageParts, o = 0, u = _.length; o < u; o++) t = _[o], c += (t.data.length - 1) * t.pageSize + t.cursor;
						for (c += t.pageSize - t.cursor, this.log("rendering finished - filesize " + Math.round(c / 1e3) + "kb"), e = new Uint8Array(c), m = 0, v = this.imageParts, s = 0, d = v.length; s < d; s++) for (t = v[s], y = t.data, n = p = 0, f = y.length; p < f; n = ++p) h = y[n], e.set(h, m), m += n === t.data.length - 1 ? t.cursor : t.pageSize;
						return r = new Blob([e], { type: "image/gif" }), this.emit("finished", r, e);
					}, t.prototype.renderNextFrame = function() {
						var e, t, n, r;
						if (this.freeWorkers.length === 0) throw Error("No free workers");
						if (!(this.nextFrame >= this.frames.length)) return e = this.frames[this.nextFrame++], t = this.frames.indexOf(e), t > 0 && this.groups.has(e.data) && this.groups.get(e.data)[0] !== t ? void setTimeout(function(t) {
							return function() {
								return t.frameFinished(e, !0);
							};
						}(this), 0) : (r = this.freeWorkers.shift(), n = this.getTask(e), this.log("starting frame " + (n.index + 1) + " of " + this.frames.length), this.activeWorkers.push(r), r.postMessage(n));
						...
						var t;
						return this._canvas ?? (this._canvas = document.createElement("canvas"), this._canvas.width = this.options.width, this._canvas.height = this.options.height), t = this._canvas.getContext("2d"), t.setFill = this.options.background, t.fillRect(0, 0, this.options.width, this.options.height), t.drawImage(e, 0, 0), this.getContextData(t);
					}, t.prototype.getTask = function(e) {
						var t, n;
						if (t = this.frames.indexOf(e), n = {
							index: t,
						...
						else if (e.context != null) n.data = this.getContextData(e.context);
						else {
							if (e.image == null) throw Error("Invalid frame");
			...
			function(e, t) {
				...
				e.exports = n, n.EventEmitter = n, n.prototype._events = void 0, n.prototype._maxListeners = void 0, n.defaultMaxListeners = 10, n.prototype.setMaxListeners = function(e) {
					...
					var t, n, i, s, c, l;
					if (this._events ||= {}, e === "error" && (!this._events.error || a(this._events.error) && !this._events.error.length)) {
						if (t = arguments[1], t instanceof Error) throw t;
						var u = /* @__PURE__ */ Error("Uncaught, unspecified \"error\" event. (" + t + ")");
						throw u.context = t, u;
					}
					...
					if (r(n)) switch (arguments.length) {
						...
						case 3:
							...
							break;
						default: s = Array.prototype.slice.call(arguments, 1), n.apply(this, s);
					}
					else if (a(n)) for (s = Array.prototype.slice.call(arguments, 1), l = n.slice(), i = l.length, c = 0; c < i; c++) l[c].apply(this, s);
					return !0;
				}, n.prototype.addListener = function(e, t) {
					var i;
					if (!r(t)) throw TypeError("listener must be a function");
					return this._events ||= {}, this._events.newListener && this.emit("newListener", e, r(t.listener) ? t.listener : t), this._events[e] ? a(this._events[e]) ? this._events[e].push(t) : this._events[e] = [this._events[e], t] : this._events[e] = t, a(this._events[e]) && !this._events[e].warned && (i = o(this._maxListeners) ? n.defaultMaxListeners : this._maxListeners, i && i > 0 && this._events[e].length > i && (this._events[e].warned = !0, console.error("(node) warning: possible EventEmitter memory leak detected. %d listeners added. Use emitter.setMaxListeners() to increase limit.", this._events[e].length), typeof console.trace == "function" && console.trace())), this;
					...
					if (n = this._events[e], o = n.length, i = -1, n === t || r(n.listener) && n.listener === t) delete this._events[e], this._events.removeListener && this.emit("removeListener", e, t);
						...
						if (i < 0) return this;
						n.length === 1 ? (n.length = 0, delete this._events[e]) : n.splice(i, 1), this._events.removeListener && this.emit("removeListener", e, t);
					}
					return this;
			...
			function(e, t) {
				var n, r, i, a, o = navigator.userAgent.toLowerCase();
				a = navigator.platform.toLowerCase(), n = o.match(/(opera|ie|firefox|chrome|version)[\s\/:]([\w\d\.]+)?.*?(safari|version[\s\/:]([\w\d\.]+)|$)/) || [
					null,
					"unknown",
					0
				], i = n[1] === "ie" && document.documentMode, r = {
					name: n[1] === "version" ? n[3] : n[1],
					version: i || parseFloat(n[1] === "opera" && n[4] ? n[4] : n[2]),
					platform: { name: o.match(/ip(?:ad|od|hone)/) ? "ios" : (o.match(/(?:webos|android)/) || a.match(/mac|win|linux/) || ["other"])[0] }
				}, r[r.name] = !0, r[r.name + parseInt(r.version, 10)] = !0, r.platform[r.platform.name] = !0, e.exports = r;
			}
		]);
	});
})))());
...
var Le = class n {
	...
	static getInstance(e, t) {
		return n.instance ||= new n(e, t), n.instance;
	}
	static async destroyInstance() {
		n.instance &&= (await n.instance.cleanup(), null);
	}
	constructor(r = Math.min(6, Ie()), i) {
		this.isProcessing = !1;
		let a = i ?? (typeof window < "u" ? void 0 : this.workerPath);
		this.workerScript = a, n.activeInstanceCount += 1, this.sessionManager = new Ae(), this.sessionId = this.sessionManager.createSession(), this.workerPool = n.sharedWorkerPool ?? new t(r, a), n.sharedWorkerPool = this.workerPool, typeof window < "u" && console.debug("[GIFProcessor] Worker paths:", {
			requested: a ?? "(inline)",
			current: window.location.pathname,
			full: a ? new URL(a, window.location.origin).href : "(inline)"
		}), this.progTracker = new Se(), this.progManager = new Y(), this.workerManager = new De(this.workerPool), this.abort = new AbortController(), this.completedPhases = /* @__PURE__ */ new Set(), this.gifWorkerPool = n.sharedGifWorkerPool ?? new t(Math.ceil(r / 2), a), n.sharedGifWorkerPool = this.gifWorkerPool, console.debug("GifWorkerPool initialized:", this.gifWorkerPool.stats), this.workerCount = Math.min(Ie(), r), this.memoryManager = new Oe(this.sessionId, this.progTracker, r, this.workerPool, this.gifWorkerPool, this.qualityOptions, this.workerCount), this.pixelArtHandler = new K(), this.qualityManager = new J(), this.canvasPool = new e(G.POOL_SIZE, G.CANVAS_PER_SIZE, G.MEMORY_LIMIT), this.imageProcessor = new je(this.workerCount, this.pixelArtHandler, q), this.frameProcessor = new _e(this.pixelArtHandler, this.imageProcessor, this.canvasPool, q, this.workerPool, this.workerCount), this.imgManager = new Ce(this.progManager, this.workerPool, this.canvasPool), this.qualityAnalyzer = new ge(this.qualityManager, q), this.processedFramesCache = /* @__PURE__ */ new Map(), this.canvas = this.canvasPool.getCanvas(G.WORKING_SIZE, G.WORKING_SIZE), console.debug("GIFProcessor initialized with pool size:", r, "Workercount:", this.workerCount), this.memoryManager.currentMemoryStrategy = this.memoryManager.MEMORY_STRATEGIES.MEDIUM;
	}
	createGIF(e, t = !1) {
		if (!e.length) throw Error("No frames provided");
		let n = {
		...
		this.workerScript && (n.workerScript = this.workerScript);
		let r = new Fe.default(n);
		return new Promise((t, n) => {
			r.on("progress", (e) => {
				let t = Math.round(e * 100);
				this.progManager.updatePhase(X.ENCODING.id, t, `Encoding: ${t}%`);
			}), r.on("finished", (r) => {
				if (!r || !r.size) {
					n(/* @__PURE__ */ Error("Generated GIF is empty"));
					return;
				}
				console.debug("[GIF] Generation complete:", {
					size: `${Math.round(r.size / 1024)}KB`,
					type: r.type
				}), e.forEach((e) => e.bitmap.close()), this.progManager.resetProgress(), this.progTracker.completePhase(X.ENCODING.id), t(r);
			}), r.on("error", (e) => {
				console.error("[GIF] Encoding error:", e), this.progManager.resetProgress(), n(e);
			});
			let i = e.map((e) => this.workerPool.addTask(async () => {
				let t = document.createElement("canvas");
				t.width = G.TARGET_SIZE, t.height = G.TARGET_SIZE;
				let n = t.getContext("2d", {
					alpha: !0,
					willReadFrequently: !0
				});
				n && (n.clearRect(0, 0, t.width, t.height), n.globalCompositeOperation = "copy", n.drawImage(e.bitmap, 0, 0), r.addFrame(t, {
					delay: e.originalFrame.delay,
					dispose: e.originalFrame.disposalType || 2,
					transparent: !0
				}));
			}));
			Promise.all(i).then(() => {
	...
	async processFramesFromFrameProcessor(e, t) {
		return await this.frameProcessor.processFramesInWorkers(e, t);
	}
	async streamGIF(e, t, n, r) {
		if (this.isProcessing) return Promise.reject(/* @__PURE__ */ Error("GIF processing already in progress"));
		this.isProcessing = !0;
		try {
			let { frames: i, metadata: a, quality: o } = await this.analyzeGIF(e);
			this.memoryManager.validateInput(i, t, n);
			let { readable: s, writable: c } = new TransformStream(), l = c.getWriter();
			return (async () => {
				try {
					let e = [], r, s = await this.imgManager.loadAndCreateStaticImage(t, n), c = q.analyzeGIFFrameDimensions(i);
					if (a.isPixelArt || c.hasVariableSize) {
						let e = i.map((e, t) => this.pixelArtHandler.processPixelArtFrame(e, c, t)), t = await Promise.all(e.map(async (e) => this.frameProcessor.processFrameOG(await this.imageProcessor.preOptimizeGifFrame(e, !0, "PIXEL"))));
						r = await this.imageProcessor.createImgBitmap(t, s);
					} else {
						let e = await Promise.all(i.map(async (e) => this.frameProcessor.processFrameOG(await this.imageProcessor.preOptimizeGifFrame(e, !0, o || "HIGH"))));
						r = await this.imageProcessor.createImgBitmap(e, s);
					}
					l.write(new TextEncoder().encode(JSON.stringify({
						status: "Processing frame",
						frameIndex: e.length
					}) + "\n")), this.progManager.updatePhase(X.PROCESSING.id, 100, "Frame processing complete"), await this.createGIFStream(r, l);
				} catch (e) {
					console.error("GIF streaming failed:", e), l.abort(e), r?.(e instanceof Error ? e : Error(String(e)));
				}
			})(), s;
		} catch (e) {
			throw console.error("GIF streaming initialization failed:", e), r?.(e instanceof Error ? e : Error(String(e))), e;
		}
	}
	async createGIFStream(e, t, n = {
		width: 400,
		height: 300
	}) {
		let r = null, i = null, a = e.map((e) => e.originalFrame);
		e.map((e) => e.bitmap);
		try {
			let o = q.analyzeGIFFrameDimensions(a), s = e[0];
			if (!s?.bitmap) throw Error("No valid frames to process");
			let c = Math.min(n.width / o.maxWidth, n.height / o.maxHeight), l = Math.round(s.bitmap.width * c), u = Math.round(s.bitmap.height * c), d = Math.floor((n.width - l) / 2), f = Math.floor((n.height - u) / 2), p = {
				workers: this.workerScript ? this.workerCount : 0,
				quality: 10,
				width: n.width,
				height: n.height,
			...
			this.workerScript && (p.workerScript = this.workerScript);
			let m = new Fe.default(p);
			if (r = document.createElement("canvas"), r.width = n.width, r.height = n.height, i = r.getContext("2d", {
				alpha: !0,
				willReadFrequently: !0
			}), !i) throw Error("Failed to get canvas context");
			for (let r = 0; r < e.length; r++) {
				let a = e[r];
				a.bitmap && (i.clearRect(0, 0, n.width, n.height), i.drawImage(a.bitmap, d, f, l, u), m.addFrame(i, {
					copy: !0,
					delay: a.originalFrame?.delay || 100,
					dispose: a.originalFrame?.disposalType || 2
				}), t.write(new TextEncoder().encode(JSON.stringify({
					type: "progress",
					frameIndex: r + 1,
					total: e.length,
					dimensions: {
			...
			return new Promise((e, n) => {
				m.on("finished", async (r) => {
					try {
						let n = URL.createObjectURL(r);
						await t.write(new TextEncoder().encode(JSON.stringify({
							type: "complete",
							url: n,
							dimensions: {
								width: l,
				...
				}), m.on("error", n), m.render();
			});
		} catch (e) {
			throw console.error("GIF stream error:", e), t.abort(e), e;
		} finally {
			r && i && (i.clearRect(0, 0, r.width, r.height), r.width = 0, r.height = 0), e.forEach((e) => {
				e.bitmap && e.bitmap.close();
			});
		}
	}
	async generateGIF(e, t, n, r, i = {}, a) {
		(i.forceQuality || i.allowAutoDetect !== void 0) && this.memoryManager.setQualityOptions(i), this.totalFramesCount = e.length, this.processedFramesCount = 0;
		try {
			this.memoryManager.validateInput(e, t, n);
			let a = q.analyzeGIFFrameDimensions(e), o = await q.detectPixelArtInAllFrames(e);
			if (!r) {
				let e = a.maxWidth > G.TARGET_SIZE || a.maxHeight > G.TARGET_SIZE;
				r = o ? e || a.hasVariableSize ? "HIGHRESPIXEL" : "PIXEL" : e || a.hasVariableSize ? "HIGHRES" : "HIGH";
			}
			let s = fe[r];
			i.optimizeFrames && (s.disposalMethod = 1, s.synchronizeFrames = !0, s.blendMode = "copy"), console.debug("Selected quality settings:", s);
			let c, l = await this.imgManager.loadAndCreateStaticImage(t, n);
			if (o || a.hasVariableSize) {
				let t = e.map((e, t) => this.pixelArtHandler.processPixelArtFrame(e, a, t)), n = await Promise.all(t.map(async (e) => this.frameProcessor.processFrameOG(await this.imageProcessor.preOptimizeGifFrame(e, !0, "PIXEL"))));
				c = await this.imageProcessor.createImgBitmap(n, l);
			} else {
				let t = await Promise.all(e.map(async (e) => this.frameProcessor.processFrameOG(await this.imageProcessor.preOptimizeGifFrame(e, !0, r || "HIGH"))));
				c = await this.imageProcessor.createImgBitmap(t, l);
			}
			let u = await this.createGIF(c, !1);
			return Object.values(X).forEach((e) => {
				this.completedPhases.has(e.id) || this.progManager.updatePhase(e.id, 100, `${e.name} complete`);
			}), this.progManager.resetProgress(), this.memoryManager.clear(), u;
		} catch (e) {
			throw console.error("GIF generation failed:", e), a?.(e instanceof Error ? e : Error(String(e))), e;
		}
	}
	async extractFrames(e) {
		try {
			let t = this.imgManager.getCacheKey(e);
			if (this.processedFramesCache.has(t)) return console.debug("Using cached frames for:", e), this.processedFramesCache.get(t);
			this.progManager.updatePhase(X.EXTRACTING.id, 0, "Starting frame extraction...");
			let n = await (await Pe(e)).arrayBuffer(), r = await q.analyzeGIF(n);
			console.debug("GIF Analysis:", r), this.progManager.updatePhase(X.EXTRACTING.id, 20, "Decompressing frames...");
			let i = (0, W.decompressFrames)((0, W.parseGIF)(n), !0), a = this.qualityManager.selectOptimalQuality(r);
			return console.debug("Selected quality preset:", a), this.processedFramesCache.set(t, i), this.progManager.updatePhase(X.EXTRACTING.id, 100, "Frame extraction complete"), i;
		} catch (e) {
			throw console.error("Frame extraction failed:", e), e;
		}
	}
	async analyzeGIF(e) {
		try {
			let t = await (await Pe(e)).arrayBuffer(), { quality: n, metadata: r } = await this.qualityAnalyzer.analyzeGifQuality(e);
			return console.debug("[GIF Analysis]", r, "Quality:", n), {
				metadata: r,
				quality: n,
				frames: (0, W.decompressFrames)((0, W.parseGIF)(t), !0)
			};
		} catch (e) {
			throw console.error("GIF analysis failed:", e), e;
		}
	}
	CHUNK_SIZE = 5;
	...
	async processFramesInChunks(e) {
		let t = [];
		for (let n = 0; n < e.length; n += this.CHUNK_SIZE) {
			let r = e.slice(n, n + this.CHUNK_SIZE), i = await Promise.all(r.map((e) => this.frameProcessor.processFrameOG(e)));
			t.push(...i), await new Promise((e) => setTimeout(e, 0));
		}
		return t;
	}
	async processFramesInWorkers(e) {
		let t = q.analyzeGIFFrameDimensions(e), n = e.map((e) => this.pixelArtHandler.processPixelArtFrame(e, t, 0)), r = Math.ceil(n.length / this.workerCount), i = [];
		for (let e = 0; e < n.length; e += r) i.push(n.slice(e, e + r));
		return (await Promise.all(i.map(async (e) => this.workerPool.addTask(async () => Promise.all(e.map(async (e) => this.frameProcessor.processFrame(await this.imageProcessor.preOptimizeGifFrame(e, !0, "HIGH"), null))))))).flat();
	}
	cleanup() {
		this.isProcessing = !1, this.completedPhases.clear(), this.processedFramesCache.clear(), this.progManager.resetProgress(), this.memoryManager.cleanup?.(), this.sessionId && this.sessionManager.endSession(this.sessionId), this.sessionManager.cleanup(), n.activeInstanceCount = Math.max(0, n.activeInstanceCount - 1), n.activeInstanceCount === 0 && (this.workerPool.terminate?.(!0), this.gifWorkerPool.terminate?.(!0), n.sharedWorkerPool = null, n.sharedGifWorkerPool = null);
	}
};
function Re(e, t) {
	return Le.getInstance(e, t);
}
//#endregion
//#region src/decoder/BitReader.ts
var ze = class {
	nextBitToRead;
	numberOfBitsToRead;
	bitMask;
	bytes;
	constructor(e = new Uint8Array()) {
		this.nextBitToRead = 0, this.numberOfBitsToRead = 0, this.bitMask = 0, this.bytes = e;
	}
	init(e) {
		this.bytes = e, this.nextBitToRead = 0;
	}
	read() {
		let e = this.nextBitToRead >>> 3, t = this.nextBitToRead & 7, n = this.bytes[e++] & 255, r = this.bytes[e++] & 255, i = (((this.bytes[e] & 255) << 8 | r) << 8 | n) >>> t;
		return this.nextBitToRead += this.numberOfBitsToRead, i & this.bitMask;
	}
	setNumberOfBitsToRead(e) {
		this.numberOfBitsToRead = e, this.bitMask = (1 << e) - 1;
	}
}, Be = class {
	table;
	initTableSize;
	...
	constructor(e) {
		if (!e) {
			this.table = Array(4096).fill(0).map(() => []), this.initTableSize = 0, this.initCodeSize = 0, this.initCodeLimit = 0, this.codeSize = 0, this.nextCode = 0, this.nextCodeLimit = 0, this.bitReader = new ze();
			return;
		}
		this.table = e.table, this.initTableSize = this.table.length, this.initCodeSize = e.initCodeSize, this.initCodeLimit = e.initCodeLimit, this.codeSize = e.codeSize, this.nextCode = e.nextCode, this.nextCodeLimit = e.nextCodeLimit, this.bitReader = new ze();
	}
	add(e) {
		return this.nextCode < 4096 && (this.nextCode === this.nextCodeLimit && this.codeSize < 12 && (this.codeSize++, this.bitReader.setNumberOfBitsToRead(this.codeSize), this.nextCodeLimit = (1 << this.codeSize) - 1), this.table[this.nextCode++] = e), this.codeSize;
	}
	clear() {
		return this.codeSize = this.initCodeSize, this.bitReader.setNumberOfBitsToRead(this.codeSize), this.nextCodeLimit = this.initCodeLimit, this.nextCode = this.initTableSize, this.codeSize;
	}
	init(e, t, n) {
		this.bitReader = n;
		let r = t.length;
		this.initCodeSize = e.firstCodeSize, this.initCodeLimit = (1 << this.initCodeSize) - 1, this.initTableSize = e.endOfInfoCode + 1, this.nextCode = this.initTableSize;
		for (let e = r - 1; e >= 0; e--) this.table[e][0] = t[e];
		this.table[e.clearCode] = [e.clearCode], this.table[e.endOfInfoCode] = [e.endOfInfoCode], e.transpColFlag && e.transpColIndex < r && (this.table[e.transpColIndex][0] = 0);
	}
}, Ve = class {
	disposalMethod = 0;
	transpColFlag = !1;
	...
	constructor(e) {
		...
		this.disposalMethod = e.disposalMethod, this.transpColFlag = e.transpColFlag, this.delay = e.delay, this.transpColIndex = e.transpColIndex, this.x = e.x, this.y = e.y, this.w = e.w, this.h = e.h, this.wh = e.wh, this.hasLocColTbl = e.hasLocColTbl, this.interlaceFlag = e.interlaceFlag, this.sortFlag = e.sortFlag, this.sizeOfLocColTbl = e.sizeOfLocColTbl, this.localColTbl = e.localColTbl, this.firstCodeSize = e.firstCodeSize, this.clearCode = e.clearCode, this.endOfInfoCode = e.endOfInfoCode, this.data = e.data || new Uint8Array(), this.img = e.img || new ImageData(0, 0);
	}
	setDefaultValues() {
		this.disposalMethod = 0, this.transpColFlag = !1, this.delay = 0, this.transpColIndex = 0, this.x = 0, this.y = 0, this.w = 0, this.h = 0, this.wh = 0, this.hasLocColTbl = !1, this.interlaceFlag = !1, this.sortFlag = !1, this.sizeOfLocColTbl = 0, this.localColTbl = [], this.firstCodeSize = 0, this.clearCode = 0, this.endOfInfoCode = 0, this.data = new Uint8Array(), this.img = new ImageData(0, 0);
	}
}, He = class {
	header = "";
	w = 0;
	...
	bits = new ze();
	codes = new Be();
	g = document.createElement("canvas").getContext("2d", { willReadFrequently: !0 });
	constructor(e) {
		e && (Object.assign(this, e), this.header = e.header, this.w = e.w, this.h = e.h, this.wh = e.wh, this.hasGlobColTbl = e.hasGlobColTbl, this.colorResolution = e.colorResolution, this.sortFlag = e.sortFlag, this.sizeOfGlobColTbl = e.sizeOfGlobColTbl, this.bgColIndex = e.bgColIndex, this.pxAspectRatio = e.pxAspectRatio, this.globalColTbl = e.globalColTbl, this.g = document.createElement("canvas").getContext("2d", { willReadFrequently: !0 }));
	}
	processCode1(e, t, n) {
		let r = this.codes.table;
		if (e < this.codes.nextCode) {
			let i = r[e];
			return i.forEach((e, r) => t[n + r] = e), i.length;
		} else throw Error(`Invalid code encountered: ${e}`);
	}
	processCode(e, t, n, r, i, a) {
		if (e === t) return this.codes.clear(), {
			pixels: [],
			outPos: a
		};
		if (e === n) throw Error("End of GIF decoding");
		let o, s = r[this.bits.read()], c = [...s, 0];
		return e < this.codes.nextCode ? (o = r[e], c[s.length] = o[0]) : (c[s.length] = s[0], o = c), this.codes.add(c), o.forEach((e, t) => {
			i[a + t] = e;
		}), {
			pixels: o,
			outPos: a + o.length
	...
	decode(e, t) {
		this.codes.init(e, t, this.bits), this.bits.init(e.data);
		let n = e.clearCode, r = e.endOfInfoCode, i = Array(this.wh).fill(0), a = this.codes.table, o = 0;
		this.codes.clear(), this.bits.read();
		let s = this.bits.read(), c = a[s];
		c.forEach((e, t) => i[o + t] = e), o += c.length;
		try {
			for (;;) {
				let e = s;
				if (s = this.bits.read(), s === n) {
					this.codes.clear(), s = this.bits.read(), c = a[s], c.forEach((e, t) => i[o + t] = e), o += c.length;
					continue;
				} else if (s === r) break;
				let t = a[e], l = [...t, 0];
				s < this.codes.nextCode ? (c = a[s], c.forEach((e, t) => i[o + t] = e), o += c.length, l[t.length] = a[s][0]) : (l[t.length] = t[0], l.forEach((e, t) => i[o + t] = e), o += l.length), this.codes.add(l);
			}
		} catch {}
		return i;
	}
	deinterlace(e, t) {
		let n = t.w, r = t.h, i = t.wh, a = Array(e.length).fill(0), o = r + 7 >>> 3, s = o + (r + 3 >>> 3), c = s + (r + 1 >>> 2), l = n * o, u = n * s, d = n * c, f = n << 1, p = f << 1, m = p << 1, h = 0, g = 0;
		for (; h < l; h += n, g += m) e.slice(h, h + n).forEach((e, t) => a[g + t] = e);
		for (g = p; h < u; h += n, g += m) e.slice(h, h + n).forEach((e, t) => a[g + t] = e);
		for (g = f; h < d; h += n, g += p) e.slice(h, h + n).forEach((e, t) => a[g + t] = e);
		for (g = n; h < i; h += n, g += f) e.slice(h, h + n).forEach((e, t) => a[g + t] = e);
		return a;
	}
	drawFrame(e) {
		let t = e.hasLocColTbl ? e.localColTbl : this.globalColTbl, n = this.decode(e, t);
		e.interlaceFlag && (n = this.deinterlace(n, e));
		let r = new ImageData(new Uint8ClampedArray(n), e.w, e.h);
		this.g.putImageData(r, e.x, e.y);
		let i = Array(this.wh).fill(0);
		this.img && this.img.data.forEach((e, t) => i[t] = e), e.img = new ImageData(new Uint8ClampedArray(i), this.w, this.h), e.disposalMethod === 2 ? this.g.clearRect(e.x, e.y, e.w, e.h) : e.disposalMethod === 3 && this.img && this.img && i.forEach((e, t) => this.img.data[t] = e);
	}
	getBackgroundColor() {
		let e = this.frames[0];
		return e.hasLocColTbl ? e.localColTbl[this.bgColIndex] : this.hasGlobColTbl ? this.globalColTbl[this.bgColIndex] : 0;
	}
	getDelay(e) {
		return this.frames[e].delay;
	}
	getFrame(e) {
		if (this.img === null) {
			this.img = new ImageData(this.w, this.h);
			let e = document.createElement("canvas");
			e.width = this.w, e.height = this.h;
			let t = e.getContext("2d");
			if (!t) throw Error("Failed to get 2D context");
			this.g = t, this.g.fillStyle = "rgba(0,0,0,0)";
		}
		let t = this.frames[e];
		if (t.img === null) for (let n = 0; n <= e; n++) t = this.frames[n], t.img === null && this.drawFrame(t);
		return t.img;
	}
	getFrames() {
		let e = [];
		for (let t = 0; t < this.frames.length; t++) e.push(this.getFrame(t));
		return e;
	}
	getFrameCount() {
	...
	getFrameData(e) {
		let t = this.frames[e], n = this.getFrame(e);
		return {
			width: t.w,
			height: t.h,
			data: n.data,
			delay: t.delay,
			disposalMethod: t.disposalMethod,
			transparencyIndex: t.transpColFlag ? t.transpColIndex : null
		};
	}
	getAllFramesData() {
		return this.frames.map((e, t) => this.getFrameData(t));
	}
};
//#endregion
//#region src/decoder/utils.ts
function Z(e) {
	let t = new He(), n = null, r = Ke(e, t);
	for (r = Xe(t, e, r), t.hasGlobColTbl && (t.globalColTbl = Array(t.sizeOfGlobColTbl).fill(0), r = We(e, t.globalColTbl, r)); r < e.length;) switch (e[r] & 255) {
		case 33:
			if (r + 1 >= e.length) throw Error("Unexpected end of file.");
			switch (e[r + 1] & 255) {
				case 254:
					r = Ze(e, r);
					break;
				...
				case 1:
					...
					break;
				case 249:
					n === null && (n = new Ve(), t.frames.push(n)), r = Ge(n, e, r);
					break;
				default: throw Error("Unknown extension at " + r);
			}
			break;
		case 44:
			n === null && (n = new Ve(), t.frames.push(n)), r = Ye(n, e, r), n.hasLocColTbl && (n.localColTbl = Array(n.sizeOfLocColTbl).fill(0), r = We(e, n.localColTbl, r)), r = qe(n, e, r), n = null;
			break;
		case 59: return t;
		default:
			if (1 * r / e.length < .9) throw Error("Unknown block at: " + r);
			r = e.length;
	}
	return t;
}
function Ue(e, t, n) {
	if (e.appId = String.fromCharCode(...Array.from(t.slice(n + 3, n + 11))), e.appAuthCode = String.fromCharCode(...Array.from(t.slice(n + 11, n + 14))), n += 14, (t[n] & 255) == 3) return e.repetitions = t[n + 2] & 255 | (t[n + 3] & 255) << 8, n + 5;
	for (; t[n] & 255;) n += (t[n] & 255) + 1;
	return n + 1;
}
function We(e, t, n) {
	let r = t.length;
	for (let i = 0; i < r; i++) {
		let r = e[n++] & 255, a = e[n++] & 255, o = e[n++] & 255;
		t[i] = ((65280 | r) << 8 | a) << 8 | o;
	}
	return n;
}
function Ge(e, t, n) {
	return e.disposalMethod = (t[n + 3] & 28) >>> 2, e.transpColFlag = (t[n + 3] & 1) == 1, e.delay = t[n + 4] & 255 | (t[n + 5] & 255) << 8, e.transpColIndex = t[n + 6] & 255, n + 8;
}
function Ke(e, t) {
	if (e.length < 6) throw Error("Image is truncated.");
	if (t.header = String.fromCharCode(...Array.from(e.slice(0, 6))), t.header !== "GIF87a" && t.header !== "GIF89a") throw Error("Invalid GIF header.");
	return 6;
}
function qe(e, t, n) {
	let r = t.length, i = t[n++] & 255, a = 1 << i;
	e.firstCodeSize = i + 1, e.clearCode = a, e.endOfInfoCode = a + 1;
	let o = Je(t, n), s = new Uint8Array(o + 2), c = 0, l = t[n] & 255;
	for (; l > 0;) try {
		let e = n + l + 1, r = t[e] & 255;
		s.set(t.slice(n + 1, n + 1 + l), c), c += l, n = e, l = r;
	} catch {
		l = r - n - 1, s.set(t.slice(n + 1, n + 1 + l), c), c += l, n += l + 1;
		break;
	}
	return e.data = s, n++, n;
}
function Je(e, t) {
	let n = e.length, r = 0, i = e[t] & 255;
	for (; i > 0;) try {
		let n = t + i + 1, a = e[n] & 255;
		r += i, t = n, i = a;
	} catch {
		i = n - t - 1, r += i;
		break;
...
function Ye(e, t, n) {
	e.x = t[++n] & 255 | (t[++n] & 255) << 8, e.y = t[++n] & 255 | (t[++n] & 255) << 8, e.w = t[++n] & 255 | (t[++n] & 255) << 8, e.h = t[++n] & 255 | (t[++n] & 255) << 8, e.wh = e.w * e.h;
	let r = t[++n];
	return e.hasLocColTbl = (r & 128) >>> 7 == 1, e.interlaceFlag = (r & 64) >>> 6 == 1, e.sortFlag = (r & 32) >>> 5 == 1, e.sizeOfLocColTbl = 1 << (r & 7) + 1, n + 1;
}
function Xe(e, t, n) {
	e.w = t[n++] & 255 | (t[n++] & 255) << 8, e.h = t[n++] & 255 | (t[n++] & 255) << 8, e.wh = e.w * e.h;
	let r = t[n++];
	return e.hasGlobColTbl = (r & 128) >>> 7 == 1, e.colorResolution = (r & 112) >>> 4, e.sortFlag = (r & 8) >>> 3 == 1, e.sizeOfGlobColTbl = 1 << (r & 7) + 1, e.bgColIndex = t[n++] & 255, e.pxAspectRatio = t[n++] & 255, n;
}
function Ze(e, t) {
	for (; e[t] & 255;) t += (e[t] & 255) + 1;
	return t + 1;
}
//#endregion
//#region src/decoder/GifExtension.ts
var Qe = class extends He {
	readGif = async (e) => {
		let t = await (await fetch(e)).arrayBuffer();
		return Z(new Uint8Array(t));
	};
	readGifReturnBuffer = async (e) => {
		let t = await (await fetch(e)).arrayBuffer();
		return new Uint8Array(t);
	};
	returnGifDetails = async (e) => Z(await this.readGifReturnBuffer(e));
	readGifFromBuffer = (e) => Z(e);
	readGifFromBlob = async (e) => {
		let t = await e.arrayBuffer();
		return Z(new Uint8Array(t));
	};
	processGif = async (e, t) => {
		let n = (0, W.decompressFrames)((0, W.parseGIF)((await (async () => await this.readGifReturnBuffer(e))()).buffer), !0);
		return t.generateGIF(n, "", []);
	};
	processGifWithProcessor = async (e, t, n, r) => {
		let i = (0, W.decompressFrames)((0, W.parseGIF)(await (async () => await (await Pe(e)).arrayBuffer())()), !0);
		return n.generateGIF(i, t, r);
	};
};
//#endregion
//#region src/decoder/useGifDecoder.ts
async function $e(e) {
	let t = Z(await et(e));
	return {
		width: t.getWidth(),
		...
		frameCount: t.getFrameCount(),
		frames: t.getAllFramesData(),
		delays: t.frames.map((e) => e.delay)
	};
}
async function et(e) {
	if (typeof e == "string") {
		let t = await fetch(e);
		if (!t.ok) throw Error(`Failed to fetch GIF: ${t.statusText}`);
...
//#endregion
//#region src/GifExtension/index.ts
var tt = class extends He {
	...
	processor;
	constructor() {
		super(), this.gifExtension = new tt(), this.processor = new Le();
	}
	processGiffy = async (e) => await this.gifExtension.processGif(e, this.processor);
	processGiffyWithProcessor = async (e, t, n) => await this.gifExtension.processGifWithProcessor(e, t, this.processor, n);
}, rt = "https://apefathersnft.nyc3.cdn.digitaloceanspaces.com", it = `${rt}/afbgless`;
`${rt}`, v("NEXT_PUBLIC_APEFATHERS_ADDRESS", "0xE128cA01CcEb08f1b0a58C628d841Bc0EF0A4b80");
//#endregion
//#region src/services/ProcessingService.ts
var at = class {
	gifProcessor;
	canvasPool;
	CONSTANTS = { TARGET_SIZE: 2800 };
	canvasRefs;
	constructor() {
		this.gifProcessor = Le.getInstance(), this.canvasPool = new e(), this.canvasRefs = Array.from({ length: 4 }, () => this.canvasPool.getCanvas(this.CONSTANTS.TARGET_SIZE, this.CONSTANTS.TARGET_SIZE, !1));
	}
	async processImage(e, t, n, r) {
		return t !== null && t?.format.includes("gif") ? this.processGIF(e, t, n) : this.processStatic(e, t, n, r);
	}
	calculateGifFitDimensions(e) {
		let { width: t, height: n } = e.dims, r = this.CONSTANTS.TARGET_SIZE, i = t / n, a = r, o = r, s = 0, c = 0, l = t, u = n;
		return i > 1 ? (l = Math.round(n * r / r), s = Math.round((t - l) / 2)) : i < 1 && (u = Math.round(t * r / r), c = Math.round((n - u) / 2)), {
			width: a,
			height: o,
			x: 0,
			y: 0,
	...
	detectPixelArt(e) {
		...
		let o = a / r, s = i.size / r;
		return r <= 512 * 512 && (s < .15 || o >= .2);
	}
	async processGIF(e, t, n) {
		let r = `${it}/${e}.png`, i = await this.gifProcessor.extractFrames(t.url), a = this.detectPixelArt(i[0]), o = a ? "PIXEL" : "HIGH";
		return this.gifProcessor.generateGIF(i, r, n, o, {
			optimizeFrames: !a,
			disposeToBackground: a
		});
	}
	loadImage = (e) => new Promise((t, n) => {
		let r = new Image();
		r.crossOrigin = "anonymous", r.onload = () => t(r), r.onerror = (t) => {
			console.error(`Failed to load image: ${e}`, t), n(t);
		}, r.src = e;
	});
	async processStatic(e, t, n, r, i = 0) {
		let a = this.canvasRefs[i], o = a.getContext("2d", { willReadFrequently: !0 });
		if (t === null && n === null) throw Error("No background or overlays selected");
		if (!o) throw Error("Failed to get canvas context");
		if (t) {
			let e = await this.loadImage(t.url);
			o.drawImage(e, 0, 0, a.width, a.height);
		}
		let s = await this.loadImage(`${it}/${e}.png`);
		if (o.drawImage(s, 0, 0, a.width, a.height), n !== null) for (let e of n) {
			let t = await this.loadImage(e.url);
			o.drawImage(t, 0, 0, a.width, a.height);
		}
		let c = `AF${e}_${t?.name || "no-bg"}${(n ?? []).length > 0 ? `_${n.map((e) => e?.name ?? "").join("-")}` : ""}.${r}`, l = a.toDataURL(`image/${r}`);
		return this.downloadDataUrl(l, c), (await fetch(l)).blob();
	}
	downloadBlob = (e, t) => {
		let n = URL.createObjectURL(e), r = document.createElement("a");
		r.href = n, r.download = t, r.style.display = "none", document.body.appendChild(r), requestAnimationFrame(() => {
			r.click(), setTimeout(() => {
	...
	downloadDataUrl = (e, t) => {
		...
		n.href = e, n.download = t, n.style.display = "none", document.body.appendChild(n), requestAnimationFrame(() => {
	...
	qualityManager;
	constructor() {
		this.gifAnalyzer = he.getInstance(), this.qualityManager = new J();
	}
	getInstance() {
		return e.qaInstance ||= new e(), e.qaInstance;
	}
	destroyInstance() {
		this.gifAnalyzer.destroyInstance(), e.qaInstance = null;
	}
	async analyzeGif(e) {
		try {
			let t = await (await fetch(e)).arrayBuffer(), n = await this.gifAnalyzer.analyzeGIF(t);
			return {
				recommendedQuality: this.qualityManager.selectOptimalQuality(n),
				frameCount: n.frames,
				width: n.width,
				height: n.height,
				fps: Math.round(1e3 / Math.max(...n.frameExtras.frameDelays)),
			...
			throw console.error("Error analyzing GIF:", e), Error("Failed to analyze GIF");
		}
	}
	cleanup() {
		this.gifAnalyzer.destroyInstance();
	}
}, st = new ot().getInstance(), Q;
(function(e) {
...
var ct = (() => {
	let e = 0;
	return () => e++;
})(), lt = /* @__PURE__ */ Error("ffmpeg is not loaded, call `await ffmpeg.load()` first"), ut = /* @__PURE__ */ Error("called FFmpeg.terminate()"), dt = class {
	#e = null;
	#t = {};
	#n = {};
	#r = [];
	...
	loaded = !1;
	#a = () => {
		this.#e && (this.#e.onmessage = ({ data: { id: e, type: t, data: n } }) => {
			switch (t) {
				case Q.LOAD:
	...
	#o = ({ type: e, data: t }, n = [], r) => this.#e ? new Promise((i, a) => {
		let o = ct();
		this.#e && this.#e.postMessage({
			id: o,
			type: e,
			data: t
		}, n), this.#t[o] = i, this.#n[o] = a, r?.addEventListener("abort", () => {
			a(new DOMException(`Message # ${o} was aborted`, "AbortError"));
		}, { once: !0 });
	}) : Promise.reject(lt);
	on(e, t) {
		e === "log" ? this.#r.push(t) : e === "progress" && this.#i.push(t);
	}
	off(e, t) {
		e === "log" ? this.#r = this.#r.filter((e) => e !== t) : e === "progress" && (this.#i = this.#i.filter((e) => e !== t));
	}
	load = ({ classWorkerURL: e, ...t } = {}, { signal: n } = {}) => (this.#e || (this.#e = e ? new Worker(new URL(e, import.meta.url), { type: "module" }) : new Worker(new URL(
		/* @vite-ignore */
		"/assets/worker-CyhFgHU6.js",
		"" + import.meta.url
	), { type: "module" }), this.#a()), this.#o({
		type: Q.LOAD,
		data: t
	}, void 0, n));
	exec = (e, t = -1, { signal: n } = {}) => this.#o({
		type: Q.EXEC,
		data: {
			args: e,
			timeout: t
	...
	terminate = () => {
		...
		for (let t of e) this.#n[t](ut), delete this.#n[t], delete this.#t[t];
	...
	readFile = (e, t = "binary", { signal: n } = {}) => this.#o({
		type: Q.READ_FILE,
		data: {
			path: e,
			encoding: t
	...
	deleteFile = (e, { signal: t } = {}) => this.#o({
		type: Q.DELETE_FILE,
		data: { path: e }
	}, void 0, t);
	rename = (e, t, { signal: n } = {}) => this.#o({
		type: Q.RENAME,
		data: {
			oldPath: e,
			newPath: t
	...
	createDir = (e, { signal: t } = {}) => this.#o({
		type: Q.CREATE_DIR,
		data: { path: e }
	}, void 0, t);
	listDir = (e, { signal: t } = {}) => this.#o({
		type: Q.LIST_DIR,
		data: { path: e }
	}, void 0, t);
	deleteDir = (e, { signal: t } = {}) => this.#o({
		type: Q.DELETE_DIR,
		data: { path: e }
	}, void 0, t);
}, ft;
...
var pt = (e) => new Promise((t, n) => {
	...
	let t;
	if (typeof e == "string") t = /data:_data\/([a-zA-Z]*);base64,([^"]*)/.test(e) ? atob(e.split(",")[1]).split("").map((e) => e.charCodeAt(0)) : await (await fetch(e)).arrayBuffer();
	else if (e instanceof URL) t = await (await fetch(e)).arrayBuffer();
	else if (e instanceof File || e instanceof Blob) t = await pt(e);
	else return new Uint8Array();
	return new Uint8Array(t);
};
//#endregion
//#region src/utils/GifCompressor.ts
async function ht(e, t = 10) {
	let n = 1, r = 24, i = 10, a = e, o = 0;
	for (; a.size > t * 1024 * 1024 && (o++, n -= .1, r -= 5, i += 10, console.log(`🛠️ Auto-Compress Iteration #${o}: Scale=${n}, FPS=${r}, Quality=${i}`), a = await gt(e, {
		widthScale: n,
		fps: r,
		quality: i,
		maxSizeMb: t
...
async function gt(e, t) {
	let { widthScale: n = .8, fps: r = 15, quality: i = 20, maxSizeMb: a = 10 } = t, o = await createImageBitmap(e), s = o.width * n, c = o.height * n, l = new OffscreenCanvas(s, c).getContext("2d");
	l.drawImage(o, 0, 0, s, c);
	let u = new Fe.default({
		workers: 2,
		quality: i,
		debug: !0,
		width: s,
	...
	u.addFrame(l, { delay: 100 });
	let d = await new Promise((e) => {
		u.on("finished", (t) => e(t)), u.render();
	});
	console.log(`📏 gif.js.optimized compressed size: ${d.size / 1024 / 1024} MB`);
	let f = new dt();
	f.loaded || await f.load();
	let p = "input.gif", m = "output.gif";
	await f.writeFile(p, await mt(d)), await f.exec([
		"-i",
		p,
		"-vf",
		`fps=${r},scale=w=iw*${n}:h=-1:flags=lanczos`,
		"-c:v",
		"gif",
		m
	]);
	let h = yt(await f.readFile(m));
	return console.log(`✅ Final compressed size: ${h.size / 1024 / 1024} MB`), h.size > a * 1024 * 1024 && console.warn("⚠️ GIF size still exceeds limit after FFmpeg compression."), h;
}
function _t(e = !0) {
	let t = document.createElement("input");
	t.type = "file", t.accept = "image/gif", t.addEventListener("change", async (t) => {
		let n = t.target.files?.[0];
		if (!n) return;
		console.log(`📂 Selected File: ${n.name} (${n.size / 1024 / 1024} MB)`);
		let r;
		r = e ? await ht(n, 10) : await gt(n, {
			widthScale: .7,
			fps: 10,
			quality: 30,
			maxSizeMb: 5
		}), bt(r, "compressed_" + n.name);
	}), t.click();
}
function vt(e) {
	return new Promise((t, n) => {
		let r = new Image();
		r.onload = () => t(r), r.onerror = n, r.src = URL.createObjectURL(yt(e));
	});
}
function yt(e) {
	if (typeof e == "string") return new Blob([e], { type: "image/gif" });
	if (e instanceof Uint8Array) {
		if (e.buffer instanceof ArrayBuffer) return new Blob([e], { type: "image/gif" });
		let t = new Uint8Array(e.byteLength);
		return t.set(e), new Blob([t], { type: "image/gif" });
	}
	throw Error(`Unsupported FFmpeg file data type: ${typeof e}`);
}
function bt(e, t) {
	let n = document.createElement("a");
	n.href = URL.createObjectURL(e), n.download = t, document.body.appendChild(n), n.click(), document.body.removeChild(n);
}
//#endregion
//#region src/utils/PixelGifScaler.ts
var xt = class {
	targetSize;
	constructor(e) {
		this.targetSize = e;
	...
	calculateScaling(e) {
		...
		return {
			maxWidth: n,
			maxHeight: r,
			baseScale: Math.floor(Math.min(this.targetSize / n, this.targetSize / r)),
			frameScales: t.map((e) => ({
				widthScale: n / e.width,
				heightScale: r / e.height
			})).map(({ widthScale: e, heightScale: t }) => Math.min(e, t))
		};
	}
	scaleFrame(e, t, n) {
		let { maxWidth: r, maxHeight: i, baseScale: a, frameScales: o } = n, s = o[t] * a, c = Math.round(e.dims.width * s), l = Math.round(e.dims.height * s), u = Math.floor((r * a - c) / 2), d = Math.floor((i * a - l) / 2), f = new ImageData(r * a, i * a);
		for (let t = 0; t < l; t++) for (let n = 0; n < c; n++) {
			let r = Math.floor(n / s), i = (Math.floor(t / s) * e.dims.width + r) * 4, a = ((t + d) * f.width + (n + u)) * 4;
			f.data[a] = e.patch[i], f.data[a + 1] = e.patch[i + 1], f.data[a + 2] = e.patch[i + 2], f.data[a + 3] = e.patch[i + 3];
		}
		return f;
	}
};
async function St(e, t) {
	let n = new xt(t), r = n.calculateScaling(e);
	return e.map((e, t) => {
		let i = n.scaleFrame(e, t, r);
		return {
			...e,
			patch: i.data,
			dims: {
...
var Ct = class extends n {
	...
	isCanceled = !1;
	cancelUpload() {
		this.status.isLoading && (this.isCanceled = !0, this.status.isLoading = !1, this.emit("statusChange", this.status));
	}
	async uploadTemporaryGif(e) {
		this.status.isLoading = !0, this.status.progress = 0, this.emit("statusChange", this.status);
		try {
			if (!this.validateFile(e)) throw Error("Invalid file format or size");
			await this.simulateProgress(500);
			let t = await this.createObjectURL(e);
			return this.temporaryGif = t, this.status.progress = 100, this.emit("statusChange", this.status), t;
		} catch (e) {
			let t = e instanceof Error ? e.message : "An unexpected error occurred.";
			return this.status.error = t, this.emit("statusChange", this.status), null;
		} finally {
			this.status.isLoading = !1, this.emit("statusChange", this.status);
		}
	}
	validateFile(e) {
		let t = this.config.allowedFileType.includes(e.type), n = e.size <= this.config.maxSizeInMB * 1024 * 1024;
		return t && n;
	}
	async createObjectURL(e) {
		return URL.createObjectURL(e);
	}
	async simulateProgress(e) {
		for (let t = 0; t <= 100; t += 10) this.status.progress = t, this.emit("statusChange", this.status), await new Promise((t) => setTimeout(t, e));
	}
	getTemporaryGif() {
		return this.temporaryGif;
	}
	cleanup() {
		this.temporaryGif &&= (URL.revokeObjectURL(this.temporaryGif), null);
	}
}, wt = () => {
	let [e, t] = (0, z.useState)(!1), [n, r] = (0, z.useState)(""), [i, a] = (0, z.useState)([]), o = (0, z.useMemo)(() => Le.getInstance(), []);
	return {
		processGIF: (0, z.useCallback)(async (e, n, r) => {
			t(!0);
			try {
				let t = await o.extractFrames(e);
				return r ? await o.generateGIF(t, n, r) : await o.generateGIF(t, n);
			} catch (e) {
				throw console.error("Error processing GIF:", e), e;
			} finally {
				t(!1);
			}
		}, [o]),
		isProcessing: e,
		currentBackground: n,
		setCurrentBackground: r,
		currentOverlays: i,
		setCurrentOverlays: a
	};
}, Tt = (0, z.useCallback)(async (e) => {
	let t = document.createElement("canvas"), n = t.getContext("2d", { willReadFrequently: !0 });
	if (!n) throw Error("Could not create canvas context");
	let r = new Image();
	return r.src = e.src, await new Promise((e, t) => {
		r.onload = () => e(), r.onerror = (e) => t(e);
	}), t.width = r.width, t.height = r.height, n.drawImage(r, 0, 0), t;
}, []);
(0, z.useCallback)(async (e) => await Promise.all(e.map(async (e) => await Tt(e))), [Tt]);
//#endregion
//#region src/utils/gifTools.ts
var Et = class {
	CONSTANTS = {
		MAX_CANVAS_SIZE: 2800,
		WORKING_SIZE: 800,
	...
	constructor(e) {
		this.progTracker = e, this.completedPhases = /* @__PURE__ */ new Set();
	}
	async loadImage(e) {
		return new Promise((t, n) => {
			let r = new Image();
	...
	generatePatch(e, t) {
		let n = e.patch.length, r = new Uint8ClampedArray(n);
		for (let i = 0; i < n; i += 4) {
			let n = Math.floor(i / 4), a = t[e.pixels[n] || 0] || [
				255,
				255,
				255
			];
			r[i] = a[0], r[i + 1] = a[1], r[i + 2] = a[2], r[i + 3] = 255;
		}
		return r;
	}
	preOptimizeGifFrame(e, t = !1, n = "FIRE") {
		this.QUALITY_PRESETS[n];
		let r = this.enhanceColorTable(e.colorTable, t, n), i = this.generatePatch(e, r);
		return {
			...e,
			colorTable: r,
			patch: i
	...
	enhanceColorTable(e, t, n) {
		return this.QUALITY_PRESETS[n], e.map((e) => {
	...
	async loadAndCreateStaticImage(e, t) {
		try {
			this.updatePhase(X.CREATE_STATIC.id, 0, "Starting static layer creation...");
			let n = await this.loadImage(e);
			this.updatePhase(X.CREATE_STATIC.id, 20, "Background loaded");
			let r = document.createElement("canvas");
			r.width = this.CONSTANTS.TARGET_SIZE, r.height = this.CONSTANTS.TARGET_SIZE;
			let i = r.getContext("2d", { willReadFrequently: !0 });
			if (!i) throw Error("Failed to get canvas context");
			let a = Math.min(this.CONSTANTS.TARGET_SIZE / this.CONSTANTS.NFT_SIZE, this.CONSTANTS.TARGET_SIZE / this.CONSTANTS.NFT_SIZE), o = Math.round(this.CONSTANTS.NFT_SIZE * a), s = Math.round(this.CONSTANTS.NFT_SIZE * a), c = this.calculateCenteredPosition(this.CONSTANTS.TARGET_SIZE, o), l = this.calculateCenteredPosition(this.CONSTANTS.TARGET_SIZE, s);
			if (i.drawImage(n, c, l, o, s), t?.length) {
				this.updatePhase(X.CREATE_STATIC.id, 50, "Adding overlays...");
				for (let e = 0; e < t.length; e++) {
					let n = t[e], r = await this.loadImage(n.url);
					i.drawImage(r, c, l, o, s), this.updatePhase(X.CREATE_STATIC.id, 20 + Math.round((e + 1) / t.length * 80), `Processing overlay ${e + 1}/${t.length}`);
				}
			}
			return this.updatePhase(X.CREATE_STATIC.id, 100, "Static layer complete"), r;
		} catch (e) {
			throw console.error("Error creating static image:", e), e;
		}
	}
	updatePhase(e, t, n, r) {
		this.progTracker.updateProgress(e, t, n);
		let i = Math.round(Object.values(X).reduce((n, r) => r.id === e ? n + r.weight * t / 100 : this.completedPhases.has(r.id) ? n + r.weight : n, 0));
		this.progTracker.updateProgress(e, t, n), window.dispatchEvent(new CustomEvent("gif-phase-update", { detail: {
			phaseId: e,
			currentProgress: t,
			overallProgress: i,
			message: n,
			timestamp: Date.now(),
			eta: r !== void 0 && (e === X.PROCESSING.id || e === X.ENCODING.id) ? this.calculateETA(Math.floor(t / 100 * r), r) : void 0
		} })), t >= 100 && (this.progTracker.updateProgress(e, 100, n), this.completedPhases.add(e));
	}
	processingStartTime = 0;
	framesProcessed = 0;
	averageFrameTime = 0;
	calculateETA(e, t) {
		let n = Date.now(), r = n - this.processingStartTime;
		if (e === 0) return this.processingStartTime = n, "Calculating...";
		this.framesProcessed = e, this.averageFrameTime = r / e;
		let i = (t - e) * this.averageFrameTime;
		if (i < 1e3) return "Less than a second";
	...
	validateInput(e, t, n) {
		if (!e?.length) throw Error("No frames provided");
		if (!t) throw Error("No background image URL provided");
		if (!Array.isArray(n)) throw Error("Invalid overlays format");
	}
	optimizeGifFrame(e, t = !1) {
		let n = document.createElement("canvas");
		n.width = this.CONSTANTS.TARGET_SIZE, n.height = this.CONSTANTS.TARGET_SIZE;
		let r = n.getContext("2d", {
			willReadFrequently: !0,
			alpha: !1
		});
		if (r && (r.imageSmoothingEnabled = !0, r.imageSmoothingQuality = "high", r.fillStyle = "#FFFFFF", r.fillRect(0, 0, n.width, n.height), r.globalCompositeOperation = "copy", r.drawImage(e, 0, 0, n.width, n.height), t)) {
			let e = r.getImageData(0, 0, n.width, n.height), t = e.data;
			for (let e = 0; e < t.length; e += 4) t[e] > t[e + 1] && t[e] > t[e + 2] && (t[e] = Math.min(255, t[e] * 1.2), t[e + 1] *= .9, t[e + 2] *= .8), t[e + 3] = 255;
			r.putImageData(e, 0, 0);
		}
		return n;
	}
	calculateGifFitDimensions(e, t) {
		let n = this.CONSTANTS.TARGET_SIZE, r = e / t, i, a, o = 0, s = 0, c = e, l = t;
		return r > 1 ? (a = n, i = n, l = t, c = Math.round(t), o = Math.round((e - c) / 2)) : (i = n, a = n, c = e, l = Math.round(e), s = Math.round((t - l) / 2)), {
			width: i,
			height: a,
			x: 0,
	...
	normalizeFrameData(e, t, n) {
		let r = t * n * 4, i = e.length;
		if (i === r) return new Uint8ClampedArray(e);
		console.debug(`Normalizing frame data: ${i} -> ${r} bytes`);
		let a = new Uint8ClampedArray(r);
		if (i === t * n * 3) for (let t = 0, n = 0; t < i; t += 3, n += 4) a[n] = e[t], a[n + 1] = e[t + 1], a[n + 2] = e[t + 2], a[n + 3] = 255;
		else {
			let t = Math.floor(i / 4) * 4;
			for (let n = 0; n < t; n++) a[n] = e[n];
			for (let e = t; e < r; e += 4) a[e] = 0, a[e + 1] = 0, a[e + 2] = 0, a[e + 3] = 0;
		}
		return a;
	}
}, Dt = [], Ot, kt;
function At(e) {
	Ot = document.getElementById(e), kt = Ot.getContext("2d");
}
function jt() {
	return new Promise((e) => {
		let t = new Image();
		t.src = "path/to/current/gif/frame.png", t.onload = () => e(t);
	});
}
function Mt(e) {
	let t = Dt.findIndex((t) => t.id === e.id);
	return t > -1 ? Dt.splice(t, 1) : Dt.push(e), Pt();
}
async function Nt() {
	await Promise.all(Dt.map((e) => new Promise((t) => {
		let n = new Image();
		n.src = e.src, n.onload = () => {
			kt.drawImage(n, e.x, e.y, e.width, e.height), t();
		}, n.onerror = () => t();
	})));
}
async function Pt() {
	kt.clearRect(0, 0, Ot.width, Ot.height);
	let e = await jt();
	return kt.drawImage(e, 0, 0, Ot.width, Ot.height), Nt();
}
async function Ft() {
	setInterval(async () => {
		Pt();
...
document.querySelectorAll(".overlay-checkbox").forEach((e) => {
	e.addEventListener("change", (e) => {
		let t = e.target;
		Mt({
			id: t.id,
			src: t.dataset.src,
			x: parseInt(t.dataset.x ?? "0", 10),
			y: parseInt(t.dataset.y ?? "0", 10),
			width: parseInt(t.dataset.width ?? "0", 10),
			height: parseInt(t.dataset.height ?? "0", 10)
		});
	});
});
//#endregion
//#region src/analyzers/BaseImageAnalyzer.ts
var Lt = class {
	async analyzeImage(e) {
		let t = await this.decodeImage(e), { width: n, height: r, data: i } = this.getPixelData(t), a = this.detectTransparency(i), o = this.detectPartialTransparency(i), s = this.countUniqueColors(i), c = this.countVisiblePixels(i), l = c > 0 ? s / c : 0, u = this.computeSharpEdgeRatio(i, n, r), d = this.extractDominantColors(i), f = n * r > 512 * 512;
		return {
			isPixelArt: n * r <= 256 * 256 && s <= 256 && l <= .12 && u > .35,
			isAnimated: !1,
			hasTransparency: a,
			hasPartialTransparency: o,
			uniqueColorCount: s,
			colorDensityRatio: l,
			sharpEdgeRatio: u,
			dominantColors: d,
			isFireLike: this.detectFireLike(d),
			isHighRes: f,
			hasVariableFrameSizes: !1
		};
	}
	async profileForScanForge(e, t) {
		let n = await this.analyzeImage(e), r = e.byteLength, i = this.determineStyle(n, t), a = this.inferOrigin(n, t, r), o = this.assessDeletionRisk(i, a, n);
		return {
			filename: t,
			bytes: r,
			style: i,
			...
			deletionRisk: o,
			analysis: n,
			notes: this.buildNotes(i, a, o, n)
		};
	}
	determineStyle(e, t) {
		let n = t.split(".").pop()?.toLowerCase() ?? "";
		return e.isPixelArt ? "pixel-art" : e.uniqueColorCount <= 8 && !e.hasPartialTransparency && !e.isHighRes ? "flat-icon" : !e.hasTransparency && e.colorDensityRatio < .05 && e.uniqueColorCount < 512 ? "generated-export" : e.uniqueColorCount > 8e3 && !e.hasTransparency && [
			"jpg",
			"jpeg",
			"webp"
		].includes(n) ? "photograph" : e.hasPartialTransparency && e.sharpEdgeRatio > .2 ? "illustrated-asset" : "unknown";
	}
	inferOrigin(e, t, n) {
		let r = t.toLowerCase();
		return n < 4096 && e.uniqueColorCount <= 16 ? "dependency-asset" : /\.(min|chunk|bundle|hash|contenthash)/.test(r) || /[-_]\w{8,}\.(png|jpg|webp)$/.test(r) ? "build-artifact" : /\b(placeholder|fixture|mock|test|spec|sample)\b/.test(r) ? "test-fixture" : e.hasPartialTransparency || e.isPixelArt ? "source-asset" : "unknown";
	}
	assessDeletionRisk(e, t, n) {
		return t === "build-artifact" || t === "dependency-asset" || t === "test-fixture" && e !== "illustrated-asset" ? "low" : t === "source-asset" || n.hasPartialTransparency && n.sharpEdgeRatio > .3 ? "high" : "medium";
	}
	buildNotes(e, t, n, r) {
		let i = [];
		return n === "high" && i.push("Likely hand-authored — verify before deleting"), t === "build-artifact" && i.push("Matches build output naming pattern"), t === "dependency-asset" && i.push("Tiny file consistent with npm-shipped asset"), e === "pixel-art" && i.push("Pixel art detected — may be intentional game/UI asset"), r.isFireLike && i.push("Warm dominant palette — possibly a branded/themed asset"), r.uniqueColorCount > 1e4 && i.push("High color complexity — likely photograph or gradient-heavy export"), i;
	}
	detectTransparency(e) {
		for (let t = 3; t < e.length; t += 4) if (e[t] === 0) return !0;
		return !1;
	}
	detectPartialTransparency(e) {
		for (let t = 3; t < e.length; t += 4) if (e[t] > 0 && e[t] < 255) return !0;
		return !1;
	}
	countVisiblePixels(e) {
		let t = 0;
		for (let n = 3; n < e.length; n += 4) e[n] > 0 && t++;
		return t;
	}
	countUniqueColors(e) {
		let t = /* @__PURE__ */ new Set();
		for (let n = 0; n < e.length; n += 4) e[n + 3] !== 0 && t.add(e[n] << 16 | e[n + 1] << 8 | e[n + 2]);
		return t.size;
	}
	computeSharpEdgeRatio(e, t, n) {
		let r = 0, i = 0;
		for (let a = 1; a < n - 1; a++) for (let n = 1; n < t - 1; n++) {
			let o = (a * t + n) * 4;
			if (e[o + 3] === 0) continue;
			r++;
			let s = (a * t + (n + 1)) * 4, c = ((a + 1) * t + n) * 4, l = (t, n) => e[n + 3] > 0 && (Math.abs(e[t] - e[n]) > 32 || Math.abs(e[t + 1] - e[n + 1]) > 32 || Math.abs(e[t + 2] - e[n + 2]) > 32);
			(l(o, s) || l(o, c)) && i++;
		}
		return r > 0 ? i / r : 0;
	}
	extractDominantColors(e) {
		let t = /* @__PURE__ */ new Map(), n = 0;
		for (let r = 0; r < e.length; r += 4) {
			if (e[r + 3] === 0) continue;
			let i = `${Math.floor(e[r] / 16) * 16},${Math.floor(e[r + 1] / 16) * 16},${Math.floor(e[r + 2] / 16) * 16}`;
			t.set(i, (t.get(i) || 0) + 1), n++;
		}
	...
	detectFireLike(e) {
		return e.some((e) => e.frequency > .15 && e.r > e.g * 1.4 && e.r > e.b * 1.4 && e.r > 180);
	}
	...
	getPixelData(e) {
		let t = new OffscreenCanvas(e.width, e.height).getContext("2d", { willReadFrequently: !0 });
		if (!t) throw Error("Failed to get 2D context");
		t.drawImage(e, 0, 0);
 ...
 /* istanbul ignore next */
	...
	var n = h("fs"), r = "/usr/bin/ldd", i = "/proc/self/exe", a = 2048;
	t.exports = {
		LDD_PATH: r,
		SELF_PATH: i,
		readFileSync: (e) => {
	...
	var n = h("child_process"), { isLinux: r, getReport: i } = Bt(), { LDD_PATH: a, SELF_PATH: o, readFile: s, readFileSync: c } = Vt(), { interpreterPath: l } = Ht(), u, d, f, p = "getconf GNU_LIBC_VERSION 2>&1 || true; ldd --version 2>&1 || true", m = "", g = () => m || new Promise((e) => {
		n.exec(p, (t, n) => {
			m = t ? " " : n, e(m);
		});
	}), _ = () => {
		...
		let e = null;
		return r() && (e = await O(), e || (e = await E(), e ||= S(), e ||= C(await g()))), e;
	}, j = () => {
		let e = null;
		return r() && (e = k(), e || (e = D(), e ||= S(), e ||= C(_()))), e;
	}, M = async () => r() && await A() !== v, N = () => r() && j() !== v, P = async () => {
	...
	}, L = (e) => e.trim().split(/\s+/)[1], R = (e) => {
		let [t, n, r] = e.split(/[\r\n]+/);
		return t && t.includes(v) ? L(t) : n && r && n.includes(b) ? L(r) : null;
	};
	t.exports = {
		GLIBC: v,
		MUSL: b,
		...
		familySync: j,
		isNonGlibcLinux: M,
		isNonGlibcLinuxSync: N,
		version: async () => {
			let e = null;
			return r() && (e = await P(), e ||= I(), e ||= R(await g())), e;
		},
		versionSync: () => {
			let e = null;
			return r() && (e = F(), e ||= I(), e ||= R(_())), e;
		}
	};
})), Wt = /* @__PURE__ */ u(((e, t) => {
	...
	var { MAX_SAFE_COMPONENT_LENGTH: n, MAX_SAFE_BUILD_LENGTH: r, MAX_LENGTH: i } = Gt(), a = Wt();
	e = t.exports = {};
	...
	var n = Wt(), { MAX_LENGTH: r, MAX_SAFE_INTEGER: i } = Gt(), { safeRe: a, t: o } = Kt(), s = qt(), { compareIdentifiers: c } = Jt();
	t.exports = class e {
		constructor(t, c) {
	...
	var n = tn(), r = nn(), i = rn(), a = $t(), o = an(), s = on();
	t.exports = (e, t, c, l) => {
		switch (t) {
	...
	var r = qt(), { safeRe: i, t: a } = Kt(), o = sn(), s = Wt(), c = Yt(), l = ln();
})), ln = /* @__PURE__ */ u(((e, t) => {
	var n = /\s+/g;
	t.exports = class e {
		constructor(t, r) {
	...
	var r = new (en())(), i = qt(), a = cn(), o = Wt(), s = Yt(), { safeRe: c, t: l, comparatorTrimReplace: u, tildeTrimReplace: d, caretTrimReplace: f } = Kt(), { FLAG_INCLUDE_PRERELEASE: p, FLAG_LOOSE: m } = Gt(), h = (e) => e.value === "<0.0.0-0", g = (e) => e.value === "", _ = (e, t) => {
	...
	fn = "sharp", pn = "High performance Node.js image processing, the fastest module to resize JPEG, PNG, WebP, GIF, AVIF and TIFF images", mn = "0.34.5", hn = "Lovell Fuller <npm@lovell.info>", gn = "https://sharp.pixelplumbing.com", _n = /* @__PURE__ */ "Pierre Inglebert <pierre.inglebert@gmail.com>,Jonathan Ong <jonathanrichardong@gmail.com>,Chanon Sajjamanochai <chanon.s@gmail.com>,Juliano Julio <julianojulio@gmail.com>,Daniel Gasienica <daniel@gasienica.ch>,Julian Walker <julian@fiftythree.com>,Amit Pitaru <pitaru.amit@gmail.com>,Brandon Aaron <hello.brandon@aaron.sh>,Andreas Lind <andreas@one.com>,Maurus Cuelenaere <mcuelenaere@gmail.com>,Linus Unnebäck <linus@folkdatorn.se>,Victor Mateevitsi <mvictoras@gmail.com>,Alaric Holloway <alaric.holloway@gmail.com>,Bernhard K. Weisshuhn <bkw@codingforce.com>,Chris Riley <criley@primedia.com>,David Carley <dacarley@gmail.com>,John Tobin <john@limelightmobileinc.com>,Kenton Gray <kentongray@gmail.com>,Felix Bünemann <Felix.Buenemann@gmail.com>,Samy Al Zahrani <samyalzahrany@gmail.com>,Chintan Thakkar <lemnisk8@gmail.com>,F. Orlando Galashan <frulo@gmx.de>,Kleis Auke Wolthuizen <info@kleisauke.nl>,Matt Hirsch <mhirsch@media.mit.edu>,Matthias Thoemmes <thoemmes@gmail.com>,Patrick Paskaris <patrick@paskaris.gr>,Jérémy Lal <kapouer@melix.org>,Rahul Nanwani <r.nanwani@gmail.com>,Alice Monday <alice0meta@gmail.com>,Kristo Jorgenson <kristo.jorgenson@gmail.com>,YvesBos <yves_bos@outlook.com>,Guy Maliar <guy@tailorbrands.com>,Nicolas Coden <nicolas@ncoden.fr>,Matt Parrish <matt.r.parrish@gmail.com>,Marcel Bretschneider <marcel.bretschneider@gmail.com>,Matthew McEachen <matthew+github@mceachen.org>,Jarda Kotěšovec <jarda.kotesovec@gmail.com>,Kenric D'Souza <kenric.dsouza@gmail.com>,Oleh Aleinyk <oleg.aleynik@gmail.com>,Marcel Bretschneider <marcel.bretschneider@gmail.com>,Andrea Bianco <andrea.bianco@unibas.ch>,Rik Heywood <rik@rik.org>,Thomas Parisot <hi@oncletom.io>,Nathan Graves <nathanrgraves+github@gmail.com>,Tom Lokhorst <tom@lokhorst.eu>,Espen Hovlandsdal <espen@hovlandsdal.com>,Sylvain Dumont <sylvain.dumont35@gmail.com>,Alun Davies <alun.owain.davies@googlemail.com>,Aidan Hoolachan <ajhoolachan21@gmail.com>,Axel Eirola <axel.eirola@iki.fi>,Freezy <freezy@xbmc.org>,Daiz <taneli.vatanen@gmail.com>,Julian Aubourg <j@ubourg.net>,Keith Belovay <keith@picthrive.com>,Michael B. Klein <mbklein@gmail.com>,Jordan Prudhomme <jordan@raboland.fr>,Ilya Ovdin <iovdin@gmail.com>,Andargor <andargor@yahoo.com>,Paul Neave <paul.neave@gmail.com>,Brendan Kennedy <brenwken@gmail.com>,Brychan Bennett-Odlum <git@brychan.io>,Edward Silverton <e.silverton@gmail.com>,Roman Malieiev <aromaleev@gmail.com>,Tomas Szabo <tomas.szabo@deftomat.com>,Robert O'Rourke <robert@o-rourke.org>,Guillermo Alfonso Varela Chouciño <guillevch@gmail.com>,Christian Flintrup <chr@gigahost.dk>,Manan Jadhav <manan@motionden.com>,Leon Radley <leon@radley.se>,alza54 <alza54@thiocod.in>,Jacob Smith <jacob@frende.me>,Michael Nutt <michael@nutt.im>,Brad Parham <baparham@gmail.com>,Taneli Vatanen <taneli.vatanen@gmail.com>,Joris Dugué <zaruike10@gmail.com>,Chris Banks <christopher.bradley.banks@gmail.com>,Ompal Singh <ompal.hitm09@gmail.com>,Brodan <christopher.hranj@gmail.com>,Ankur Parihar <ankur.github@gmail.com>,Brahim Ait elhaj <brahima@gmail.com>,Mart Jansink <m.jansink@gmail.com>,Lachlan Newman <lachnewman007@gmail.com>,Dennis Beatty <dennis@dcbeatty.com>,Ingvar Stepanyan <me@rreverser.com>,Don Denton <don@happycollision.com>".split(","), vn = {
	...
	}, yn = "commonjs", bn = "lib/index.js", xn = "lib/index.d.ts", Sn = [
		"install",
		"lib",
		"src/*.{cc,h,gyp}"
	], Cn = {
		...
		"tar-fs": "^3.1.1",
		tsd: "^0.33.0"
	}, On = "Apache-2.0", kn = { node: "^18.17.0 || ^20.3.0 || >=21.0.0" }, An = { libvips: ">=8.17.3" }, jn = { url: "https://opencollective.com/libvips" }, Mn = {
		name: fn,
		description: pn,
		version: mn,
		author: hn,
	...
	var { spawnSync: n } = zt(), { createHash: r } = zt(), i = Zt(), a = $t(), o = un(), s = Ut(), { config: c, engines: l, optionalDependencies: u } = (Nn(), m(dn).default), d = i(process.env.npm_package_config_libvips || c.libvips).version, f = [
		"darwin-arm64",
		"darwin-x64",
		"linux-arm",
		"linux-arm64",
		...
		try {
			return h(`@img/sharp-libvips-dev-${y()}/include`);
		} catch {
			/* node:coverage ignore next 5 */
			try {
				return h("@img/sharp-libvips-dev/include");
			} catch {}
		}
		return "";
	}, x = () => {
		...
		try {
			return h("@img/sharp-libvips-dev/cplusplus");
		} catch {}
		return "";
	}, S = () => {
		try {
			return h(`@img/sharp-libvips-dev-${y()}/lib`);
		} catch {
			/* node:coverage ignore next 5 */
			try {
				return h(`@img/sharp-libvips-${y()}/lib`);
			} catch {}
		}
		return "";
	}, C = () => {
	...
	}, T = () => process.platform === "darwin" && process.arch === "x64" ? (n("sysctl sysctl.proc_translated", p).stdout || "").trim() === "sysctl.proc_translated: 1" : !1, E = (e) => r("sha512").update(e).digest("hex"), D = () => {
		try {
	...
	].filter(Boolean).join(":"), j = (e, t, n) => (n && n(`Detected ${t}, skipping search for globally-installed libvips`), e);
	t.exports = {
		...
		pkgConfigPath: A,
		useGlobalLibvips: (e) => {
			if (process.env.SHARP_IGNORE_GLOBAL_LIBVIPS) return j(!1, "SHARP_IGNORE_GLOBAL_LIBVIPS", e);
			if (process.env.SHARP_FORCE_GLOBAL_LIBVIPS) return j(!0, "SHARP_FORCE_GLOBAL_LIBVIPS", e);
			/* node:coverage ignore next 3 */
			if (T()) return j(!1, "Rosetta", e);
			let t = k();
	...
	var { familySync: n, versionSync: r } = Ut(), { runtimePlatformArch: i, isUnsupportedNodeRuntime: a, prebuiltPlatforms: o, minimumLibvipsVersion: s } = Pn(), c = i(), l = [
	...
	if (d) t.exports = d;
		...
		if (e && /(symbol not found|CXXABI_)/i.test(u)) try {
			let { config: e } = h(`@img/sharp-libvips-${c}/package`), t = `${n()} ${r()}`, i = `${e.musl ? "musl" : "glibc"} ${e.musl || e.glibc}`;
	...
	function f(e, t, a) {
		if (d(this.options) && this.options.debuglog("ignoring previous resize options"), this.options.widthPost !== -1 && this.options.debuglog("operation order will be: extract, resize, extract"), n.defined(e)) if (n.object(e) && !n.defined(a)) a = e;
		...
		if (n.object(a)) {
			...
			if (this._setBackgroundColourOption("resizeBackground", a.background), n.defined(a.kernel)) if (n.string(s[a.kernel])) this.options.kernel = s[a.kernel];
	...
	function R(e, t) {
		...
		} else if (e.length > 0) this.model = t || "rgb", r = P[this.model].channels, this.color = re(Array.prototype.slice.call(e, 0, r), r), this.valpha = typeof e[r] == "number" ? e[r] : 1;
	...
	R.prototype = {
		...
		round(e) {
			return e = Math.max(e || 0, 0), new R([...this.color.map(te(e)), this.valpha], this.model);
		},
		alpha(e) {
		...
		saturationl: z("hsl", 1, B(100)),
		lightness: z("hsl", 2, B(100)),
		saturationv: z("hsv", 1, B(100)),
		value: z("hsv", 2, B(100)),
		chroma: z("hcg", 1, B(100)),
		gray: z("hcg", 2, B(100)),
		white: z("hwb", 1, B(100)),
		wblack: z("hwb", 2, B(100)),
		cyan: z("cmyk", 0, B(100)),
		magenta: z("cmyk", 1, B(100)),
		yellow: z("cmyk", 2, B(100)),
		black: z("cmyk", 3, B(100)),
		x: z("xyz", 0, B(95.047)),
		y: z("xyz", 1, B(100)),
		z: z("xyz", 2, B(108.833)),
		l: z("lab", 0, B(100)),
	...
	for (let e of Object.keys(P)) {
		...
		R.prototype[e] = function(...t) {
			return this.model === e ? new R(this) : t.length > 0 ? new R(t, e) : new R([...ne(P[this.model][e].raw(this.color)), this.valpha], e);
		}, R[e] = function(...n) {
			let r = n[0];
			return typeof r == "number" && (r = re(n, t)), new R(r, e);
		};
	}
	function ee(e, t) {
	...
	function l(e, t) {
		let i;
		if (r.string(e) ? r.string(this.options.input.file) && n.resolve(this.options.input.file) === n.resolve(e) ? i = /* @__PURE__ */ Error("Cannot use same file for input and output") : o.test(n.extname(e)) && !this.constructor.format.jp2k.output.file && (i = s()) : i = /* @__PURE__ */ Error("Missing output file path"), i) if (r.fn(t)) t(i);
	...
	function S(e) {
		if (r.object(e)) {
			...
			if (r.defined(t)) if (r.integer(t) && r.inRange(t, 2, 256)) this.options.pngBitdepth = c(t);
	...
	function w(e) {
		if (r.object(e)) {
			...
			let t = e.colours || e.colors;
			if (r.defined(t)) if (r.integer(t) && r.inRange(t, 2, 256)) this.options.gifBitdepth = c(t);
			else throw r.invalidParameterError("colours", "integer between 2 and 256", t);
	...
	var n = zt(), r = Ut(), i = $(), { runtimePlatformArch: a } = Pn(), o = Fn(), s = a(), c = o.libvipsVersion(), l = o.format();
	...
	if (!c.isGlobal) if (c.isWasm) try {
		d = h("@img/sharp-wasm32/versions");
	} catch {}
	else try {
		d = h(`@img/sharp-${s}/versions`);
	} catch {
		try {
			d = h(`@img/sharp-libvips-${s}/versions`);
		} catch {}
	}
	/* node:coverage ignore next 5 */
	d.sharp = (Nn(), m(dn).default).version, d.heif && l.heif && (l.heif.input.fileSuffix = [".avif"], l.heif.output.alias = ["avif"]);
	function f(e) {
	...
	r.familySync() === r.GLIBC && !o._isUsingJemalloc() ? o.concurrency(1) : r.familySync() === r.MUSL && o.concurrency() === 1024 && o.concurrency(zt().availableParallelism());
	var g = new n.EventEmitter();
	function _() {
		return o.counters();
	}
	function v(e) {
	...
	function y(e) {
		if (i.object(e)) if (Array.isArray(e.operation) && e.operation.every(i.string)) o.block(e.operation, !0);
		else throw i.invalidParameterError("operation", "Array<string>", e.operation);
		else throw i.invalidParameterError("options", "object", e);
	}
	function b(e) {
		if (i.object(e)) if (Array.isArray(e.operation) && e.operation.every(i.string)) o.block(e.operation, !1);
		else throw i.invalidParameterError("operation", "Array<string>", e.operation);
		else throw i.invalidParameterError("options", "object", e);
	}
	t.exports = (e) => {
		e.cache = f, e.concurrency = p, e.counters = _, e.simd = v, e.format = l, e.interpolators = u, e.versions = d, e.queue = g, e.block = y, e.unblock = b;
	};
})), qn = /* @__PURE__ */ p((/* @__PURE__ */ u(((e, t) => {
	var n = In();
	Ln()(n), Rn()(n), zn()(n), Bn()(n), Un()(n), Wn()(n), Gn()(n), Kn()(n), t.exports = n;
})))()), Jn = class e extends Lt {
	static instance = null;
	constructor() {
		super();
	}
	...
	async decodeImage(e) {
		let { data: t, info: n } = await (0, qn.default)(Buffer.from(e)).ensureAlpha().raw().toBuffer({ resolveWithObject: !0 });
		return {
			data: t,
			info: n
		};
	...
	getPixelData(e) {
		return {
			...
			data: new Uint8ClampedArray(e.data.buffer, e.data.byteOffset, e.data.byteLength)
		};
	}
}, Yn = (/* @__PURE__ */ u(((e) => {
	e.createCanvas = function(e, t) {
		...
		return new Promise(function(n, r) {
			let i = Object.assign(document.createElement("img"), t);
			function a() {
			...
			i.onload = function() {
				...
				a(), r(/* @__PURE__ */ Error("Failed to load the image \"" + e + "\""));
			}, i.src = e;
		});
	};
})))(), Xn = class e extends Lt {
	static instance = null;
	constructor() {
		super();
	}
	...
	async decodeImage(e) {
		let t = await (0, Yn.loadImage)(Buffer.from(e)), n = (0, Yn.createCanvas)(t.width, t.height).getContext("2d");
		n.drawImage(t, 0, 0);
	...
	determineStyle(e, t) {
		let n = t.split(".").pop()?.toLowerCase() ?? "";
		return e.isPixelArt ? "pixel-art" : e.uniqueColorCount <= 8 && !e.hasPartialTransparency && e.isHighRes === !1 ? "flat-icon" : !e.hasTransparency && e.colorDensityRatio < .05 && e.uniqueColorCount < 512 ? "generated-export" : e.uniqueColorCount > 8e3 && !e.hasTransparency && [
			"jpg",
			"jpeg",
			"webp"
		].includes(n) ? "photograph" : e.hasPartialTransparency && e.sharpEdgeRatio > .2 ? "illustrated-asset" : "unknown";
	...
	async decodeImage(e) {
		return await createImageBitmap(new Blob([e]));
	}
	getPixelData(e) {
		let t = new OffscreenCanvas(e.width, e.height).getContext("2d", { willReadFrequently: !0 });
		if (!t) throw Error("Failed to get 2D context");
...
//#endregion
export { ae as $, Ve as A, we as B, at as C, Qe as D, $e as E, Ne as F, _e as G, be as H, Me as I, he as J, ge as K, Pe as L, ze as M, Le as N, Z as O, Re as P, se as Q, De as R, st as S, nt as T, Y as U, Se as V, ve as W, K as X, pe as Y, me as Z, gt as _, T as _t, Lt as a, B as at, _t as b, k as bt, Pt as c, R as ct, Et as d, N as dt, oe as et, wt as f, C as ft, ht as g, O as gt, St as h, E as ht, Rt as i, V as it, Be as j, He as k, It as l, F as lt, xt as m, w as mt, Xn as n, re as nt, jt as o, P as ot, Ct as p, A as pt, J as q, Jn as r, ne as rt, Ft as s, I as st, Zn as t, ie as tt, Mt as u, M as ut, bt as v, D as vt, tt as w, ot as x, j as xt, vt as y, x as yt, Ce as z };
