...
export declare function executeTaskRequest<TPayload, TResult>(registry: RuntimeTaskRegistry, request: RuntimeTaskRequest<TPayload>): Promise<RuntimeTaskResponse<TResult>>;
