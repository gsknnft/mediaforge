...
export type OverlayCategory = "Special Effects" | "Borders" | "Frames" | "Clothes" | "Head" | "Body" | "Eyes" | "Extra" | "Accessories" | "All";
export type OVCategories = OverlayCategory | "All";
export type OverlayTraits = Record<string, string[]>;
...
export interface AssetMetadata extends AssetBase {
    type: HTMLImageElement["nodeName"] | HTMLVideoElement["nodeName"] | HTMLCanvasElement["nodeName"];
    category: AssetCategory;
    source?: "registry" | "api";
    cdnUrl?: string;
    version: string;
