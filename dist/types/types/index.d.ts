...
export type ScanForgeImageProfile = {
    filename: string;
    bytes: number;
    style: "pixel-art" | "flat-icon" | "generated-export" | "photograph" | "illustrated-asset" | "unknown";
    origin: "dependency-asset" | "build-artifact" | "test-fixture" | "source-asset" | "unknown";
...
export type { ParsedFrame, ParsedGif, ParsedFrameWithoutPatch, Frame, QualityPreset, QualityPresetExtension, QualityPresetKey, QualityPresets, GifOptions, GifConstants, GIFTYPES, GIFMetadata, ProcessedFrame, PixelArtMetrics, FrameDimensions, PixelArtSettings, MemoryStrategy, QualityOptions, FrameSizeMetadata, };
