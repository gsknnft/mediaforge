...
export type VeraExpressionHint = "normal" | "focused" | "tired" | "alarmed" | "sleeping" | "offline";
...
export type TimelinePreprocessStageId = "align-anchor" | "segment-foreground" | "stabilize-mask" | "center-canvas" | "custom";
...
export type TimelinePreprocessStageFn = (frame: TimelineFrame, context: TimelinePreprocessStageContext) => Promise<TimelinePreprocessStageResult | void> | TimelinePreprocessStageResult | void;
